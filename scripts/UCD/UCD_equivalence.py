...
def genCompositeData():
    ...
    cformat.write_imports(f, ["<ucd/data/Equivalence.h>", "<string>", "<unordered_map>", "<vector>", "<ucd/core/unicode_set.h>", "<ucd/data/CaseFolding.h>"])
...
#    cformat.close_header_file(f)
    ...
    cformat.write_imports(f, ["<string>", "<map>", "<vector>", "<ucd/core/unicode_set.h>"])
