...
namespace UCD {
    ...
    namespace BLK_ns {
        enum value_t {
            ...
            Lydian, Sidetic, Meroitic_Hieroglyphs, Meroitic_Cursive,
            Kharoshthi, Old_South_Arabian, Old_North_Arabian, Manichaean,
            Avestan, Inscriptional_Parthian, Inscriptional_Pahlavi,
            Psalter_Pahlavi, Old_Turkic, Old_Hungarian, Hanifi_Rohingya,
            Garay, Rumi, Yezidi, Arabic_Ext_C, Old_Sogdian, Sogdian,
            Old_Uyghur, Chorasmian, Elymaic, Brahmi, Kaithi, Sora_Sompeng,
            Chakma, Mahajani, Sharada, Sinhala_Archaic_Numbers, Khojki,
            Multani, Khudawadi, Grantha, Tulu_Tigalari, Newa, Tirhuta,
            Siddham, Modi, Mongolian_Sup, Takri, Myanmar_Ext_C, Ahom, Dogra,
        ...
        const static std::vector<std::string> enum_names = {
            ...
            "Phoenician", "Lydian", "Sidetic", "Meroitic_Hieroglyphs",
        ...
        const static std::vector<std::string> value_names = {
            ...
            "Sidetic", "Meroitic_Hieroglyphs", "Meroitic_Cursive",
            "Kharoshthi", "Old_South_Arabian", "Old_North_Arabian",
            "Manichaean", "Avestan", "Inscriptional_Parthian",
            "Inscriptional_Pahlavi", "Psalter_Pahlavi", "Old_Turkic",
            "Old_Hungarian", "Hanifi_Rohingya", "Garay",
            "Rumi_Numeral_Symbols", "Yezidi", "Arabic_Extended_C",
            "Old_Sogdian", "Sogdian", "Old_Uyghur", "Chorasmian", "Elymaic",
            "Brahmi", "Kaithi", "Sora_Sompeng", "Chakma", "Mahajani",
            "Sharada", "Sinhala_Archaic_Numbers", "Khojki", "Multani",
            "Khudawadi", "Grantha", "Tulu_Tigalari", "Newa", "Tirhuta",
            "Siddham", "Modi", "Mongolian_Supplement", "Takri",
            "Myanmar_Extended_C", "Ahom", "Dogra", "Warang_Citi",
    ...
    namespace INPC_ns {
        ...
        const static std::vector<std::string> value_names = {
            "Not_Applicable", "Right", "Left", "Visual_Order_Left",
            "Left_And_Right", "Top", "Bottom", "Top_And_Bottom",
    ...
    namespace LB_ns {
        ...
        const static std::vector<std::string> value_names = {
            ...
            "Contingent_Break", "Aksara_Prebase", "Regional_Indicator",
            "E_Modifier"};
        const static std::vector<std::string> aliases = {{
            "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
