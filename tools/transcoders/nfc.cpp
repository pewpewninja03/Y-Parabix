...
void NFC_U8_Pipeline(PipelineBuilder & P, StreamSet * ExpansionMask, StreamSet * U8_Basis, StreamSet * FinalSelectionMask, StreamSet * TransformedBytes) {
...
void stage1_logic(PipelineBuilder & P, StreamSet * SelectedWorkBasis, StreamSet * ValidWorkMask, StreamSet * TransformedBytes) {
    ...
    NFC_U8_Pipeline(P, WorkingExpansionMask, WorkingBasis, ValidWorkMask, TransformedBytes);
...
XfrmFunctionType generate_pipeline(CPUDriver & driver) {
    ...
    if (NoFocus) {
        ...
        StreamSet * OutputBytes = P.CreateStreamSet(1, 8);
        NFC_U8_Pipeline(P, SourceExpansionMask, ExpandedBasis, ValidWorkMask, OutputBytes);
        P.CreateKernelCall<StdOutKernel>(OutputBytes);
