...
UTF16_SupplementaryBasis::UTF16_SupplementaryBasis (LLVMTypeSystemInterface & ts, StreamSet * u32basis, StreamSet * u16_SMP_basis)
: PabloKernel(ts, "UTF16_SupplementaryBasis",
...
UTF16fieldDepositMask::UTF16fieldDepositMask(LLVMTypeSystemInterface & ts, StreamSet * u32basis, StreamSet * u16fieldMask, StreamSet * extractionMask, unsigned depositFieldWidth)
: BlockOrientedKernel(ts, "u16depositMask",
{Binding{"basis", u32basis}},
...
//
UTF16_InitialMask::UTF16_InitialMask (LLVMTypeSystemInterface & ts, StreamSet * u16final, StreamSet * u16initial)
: PabloKernel(ts, "UTF16_DepositMasks",
