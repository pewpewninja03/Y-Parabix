...
namespace UCD {
    namespace AHEX_ns {
        ...
        const static UnicodeSet::run_t __AHex_set_runs[] = {{Empty, 1}, {Mixed, 3}, {Empty, 34812}};
        const static UnicodeSet::bitquad_t __AHex_set_quads[] = {0x03ff0000, 0x0000007e, 0x0000007e};
        const static UnicodeSet AHex_set{__AHex_set_runs, 3, __AHex_set_quads, 3};
        static BinaryPropertyObject property_object{AHex, std::move(AHex_set)};
    }
PropertyObject * get_AHEX_PropertyObject() {  return & AHEX_ns::property_object; }
    namespace BIDI_C_ns {
        ...
        const static UnicodeSet::run_t __Bidi_C_set_runs[] = {
        {Empty, 48}, {Mixed, 1}, {Empty, 207}, {Mixed, 2}, {Empty, 1},
        {Mixed, 1}, {Empty, 34556}};
        const static UnicodeSet::bitquad_t __Bidi_C_set_quads[] = {
        0x10000000, 0x0000c000, 0x00007c00, 0x000003c0};
        const static UnicodeSet Bidi_C_set{__Bidi_C_set_runs, 7, __Bidi_C_set_quads, 4};
        static BinaryPropertyObject property_object{Bidi_C, std::move(Bidi_C_set)};
    }
PropertyObject * get_BIDI_C_PropertyObject() {  return & BIDI_C_ns::property_object; }
    namespace DASH_ns {
        ...
        [2e3a, 2e3b], [2e40, 2e40], [2e5d, 2e5d], [301c, 301c],
        [3030, 3030], [30a0, 30a0], [fe31, fe32], [fe58, fe58],
        [fe63, fe63], [ff0d, ff0d], [10d6e, 10d6e], [10ead, 10ead] */

        const static UnicodeSet::run_t __Dash_set_runs[] = {
        ...
        {Empty, 1643}, {Mixed, 3}, {Empty, 4}, {Mixed, 1}, {Empty, 114},
        {Mixed, 1}, {Empty, 9}, {Mixed, 1}, {Empty, 32650}};
        const static UnicodeSet::bitquad_t __Dash_set_quads[] = {
        0x00002000, 0x00000400, 0x40000000, 0x00000001, 0x00000040,
        0x003f0000, 0x00080000, 0x08000000, 0x00000800, 0x00040000,
        0x04800000, 0x0c000000, 0x20000001, 0x10000000, 0x00010000,
        0x00000001, 0x00060000, 0x01000000, 0x00000008, 0x00002000,
        0x00004000, 0x00002000};
        const static UnicodeSet Dash_set{__Dash_set_runs, 29, __Dash_set_quads, 22};
        static BinaryPropertyObject property_object{Dash, std::move(Dash_set)};
    }
PropertyObject * get_DASH_PropertyObject() {  return & DASH_ns::property_object; }
    namespace DEP_ns {
        ...
        const static UnicodeSet::run_t __Dep_set_runs[] = {
        ...
        const static UnicodeSet::bitquad_t __Dep_set_quads[] = {
        0x00000200, 0x00080000, 0x02800000, 0x00000018, 0x0000fc00,
        0x00000600, 0x00000002};
        const static UnicodeSet Dep_set{__Dep_set_runs, 15, __Dep_set_quads, 7};
        static BinaryPropertyObject property_object{Dep, std::move(Dep_set)};
    }
PropertyObject * get_DEP_PropertyObject() {  return & DEP_ns::property_object; }
    namespace DIA_ns {
        ...
        [1be6, 1be6], [1bf2, 1bf3], [1c36, 1c37], [1c78, 1c7d],
        [1cd0, 1ce8], [1ced, 1ced], [1cf4, 1cf4], [1cf7, 1cf9],
        [1d2c, 1d6a], [1dc4, 1dcf], [1df5, 1dff], [1fbd, 1fbd],
        [1fbf, 1fc1], [1fcd, 1fcf], [1fdd, 1fdf], [1fed, 1fef],
        [1ffd, 1ffe], [2cef, 2cf1], [2e2f, 2e2f], [302a, 302f],
        [3099, 309c], [30fc, 30fc], [a66f, a66f], [a67c, a67d],
        [a67f, a67f], [a69c, a69d], [a6f0, a6f1], [a700, a721],
        [a788, a78a], [a7f8, a7f9], [a806, a806], [a82c, a82c],
        ...
        [10d4e, 10d4e], [10d69, 10d6d], [10efd, 10eff], [10f46, 10f50],
        [10f82, 10f85], [11046, 11046], [11070, 11070], [110b9, 110ba],
        [11133, 11134], [11173, 11173], [111c0, 111c0], [111ca, 111cc],
        [11235, 11236], [112e9, 112ea], [1133b, 1133c], [1134d, 1134d],
        [11366, 1136c], [11370, 11374], [113ce, 113d0], [113d2, 113d3],
        [113e1, 113e2], [11442, 11442], [11446, 11446], [114c2, 114c3],
        [115bf, 115c0], [1163f, 1163f], [116b6, 116b7], [1172b, 1172b],
        [11839, 1183a], [1193d, 1193e], [11943, 11943], [119e0, 119e0],
        [11a34, 11a34], [11a47, 11a47], [11a99, 11a99], [11c3f, 11c3f],
        [11d42, 11d42], [11d44, 11d45], [11d97, 11d97], [11f41, 11f42],
        [11f5a, 11f5a], [13447, 13455], [1612f, 1612f], [16af0, 16af4],
        [16b30, 16b36], [16d6b, 16d6c], [16f8f, 16f9f], [16ff0, 16ff1],
        [1aff0, 1aff3], [1aff5, 1affb], [1affd, 1affe], [1cf00, 1cf2d],
        [1cf30, 1cf46], [1d167, 1d169], [1d16d, 1d172], [1d17b, 1d182],
        [1d185, 1d18b], [1d1aa, 1d1ad], [1e030, 1e06d], [1e130, 1e136],
        [1e2ae, 1e2ae], [1e2ec, 1e2ef], [1e5ee, 1e5ef], [1e8d0, 1e8d6],
        [1e944, 1e946], [1e948, 1e94a] */
        ...
        {Empty, 2}, {Mixed, 2}, {Empty, 13}, {Mixed, 3}, {Empty, 103},
        ...
        {Mixed, 3}, {Empty, 11}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
        ...
        0x7fff0000, 0x00000ffe, 0x00100000, 0x00000010, 0x000ff800,
        0x00000c00, 0x000c0040, 0x00c00000, 0x3f000000, 0xffff0000,
        0x039021ff, 0xfffff000, 0x000007ff, 0x0000fff0, 0xffe00000,
        0xa0000000, 0xe000e003, 0x6000e000, 0x00038000, 0x00008000,
        0x0000fc00, 0x1e000000, 0x10000000, 0xb0008000, 0x30000000,
        0x00030000, 0x00000003, 0x00000700, 0x03000000, 0x00000040,
        0x00001000, 0x00000010, 0x0003ffff, 0x00007800, 0x00080000,
        ...
        0xc0000000, 0x00000008, 0x00000001, 0xffffffbf, 0x07fdffff,
        0x87000000, 0x00000060, 0x000000fc, 0x00004000, 0x00003e00,
        0xe0000000, 0x0001ffc0, 0x0000003c, 0x00000040, 0x00010000,
        ...
        0x80000000, 0x00000034, 0x00800000, 0x04000006, 0x003fff80,
        0x00008000, 0x001f0000, 0x007f0000, 0x00001800, 0xffff8000,
        0x00030000, 0x6fef0000, 0xffff3fff, 0x0000007f, 0xf807e380,
        0x00000fe7, 0x00003c00, 0xffff0000, 0x00003fff, 0x007f0000,
        0x00004000, 0x0000f000, 0x0000c000, 0x007f0000, 0x00000770};
        const static UnicodeSet Dia_set{__Dia_set_runs, 238, __Dia_set_quads, 175};
...
PropertyObject * get_DIA_PropertyObject() {  return & DIA_ns::property_object; }
    namespace EXT_ns {
        ...
        [a9cf, a9cf], [a9e6, a9e6], [aa70, aa70], [aadd, aadd],
        [aaf3, aaf4], [ff70, ff70], [10781, 10782], [10d4e, 10d4e],
        [10d6a, 10d6a], [10d6f, 10d6f], [11237, 11237], [1135d, 1135d],
        [113d2, 113d3], [115c6, 115c8], [11a98, 11a98], [16b42, 16b43],
        [16fe0, 16fe1], [16fe3, 16fe3], [1e13c, 1e13d], [1e5ef, 1e5ef],
        [1e944, 1e946] */

        const static UnicodeSet::run_t __Ext_set_runs[] = {
        {Empty, 5}, {Mixed, 1}, {Empty, 16}, {Mixed, 1}, {Empty, 27},
        {Mixed, 1}, {Empty, 12}, {Mixed, 1}, {Empty, 19}, {Mixed, 1},
        {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 23},
        {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 73}, {Mixed, 1},
        {Empty, 1}, {Mixed, 1}, {Empty, 18}, {Mixed, 1}, {Empty, 11},
        {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 156}, {Mixed, 2},
        {Empty, 2}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 888},
        {Mixed, 1}, {Empty, 47}, {Mixed, 1}, {Empty, 29}, {Mixed, 2},
        {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 675},
        {Mixed, 1}, {Empty, 64}, {Mixed, 1}, {Empty, 45}, {Mixed, 2},
        {Empty, 37}, {Mixed, 1}, {Empty, 8}, {Mixed, 1}, {Empty, 3},
        {Mixed, 1}, {Empty, 15}, {Mixed, 1}, {Empty, 37}, {Mixed, 1},
        {Empty, 645}, {Mixed, 1}, {Empty, 36}, {Mixed, 1}, {Empty, 905},
        {Mixed, 1}, {Empty, 37}, {Mixed, 1}, {Empty, 26}, {Mixed, 1},
        {Empty, 30901}};
        ...
        0x00010000, 0x00000006, 0x00004000, 0x00008400, 0x00800000,
        0x20000000, 0x000c0000, 0x000001c0, 0x01000000, 0x0000000c,
        0x0000000b, 0x30000000, 0x00008000, 0x00000070};
        const static UnicodeSet Ext_set{__Ext_set_runs, 71, __Ext_set_quads, 39};
        static BinaryPropertyObject property_object{Ext, std::move(Ext_set)};
    }
PropertyObject * get_EXT_PropertyObject() {  return & EXT_ns::property_object; }
    namespace HEX_ns {
        ...
        const static UnicodeSet::run_t __Hex_set_runs[] = {
        {Empty, 1}, {Mixed, 3}, {Empty, 2036}, {Mixed, 3}, {Empty, 32773}};
        const static UnicodeSet::bitquad_t __Hex_set_quads[] = {
        0x03ff0000, 0x0000007e, 0x0000007e, 0x03ff0000, 0x0000007e,
        0x0000007e};
        const static UnicodeSet Hex_set{__Hex_set_runs, 5, __Hex_set_quads, 6};
        static BinaryPropertyObject property_object{Hex, std::move(Hex_set)};
    }
...
PropertyObject * get_HYPHEN_PropertyObject() {  return & HYPHEN_ns::property_object; }
    namespace IDSB_ns {
        ...
        [2ff0, 2ff1], [2ff4, 2ffd], [31ef, 31ef] */

        const static UnicodeSet::run_t __IDSB_set_runs[] = {
        {Empty, 383}, {Mixed, 1}, {Empty, 15}, {Mixed, 1}, {Empty, 34416}};
        const static UnicodeSet::bitquad_t __IDSB_set_quads[] = {0x3ff30000, 0x00008000};
        const static UnicodeSet IDSB_set{__IDSB_set_runs, 5, __IDSB_set_quads, 2};
        static BinaryPropertyObject property_object{IDSB, std::move(IDSB_set)};
    }
PropertyObject * get_IDSB_PropertyObject() {  return & IDSB_ns::property_object; }
    namespace IDST_ns {
        ...
        const static UnicodeSet::run_t __IDST_set_runs[] = {{Empty, 383}, {Mixed, 1}, {Empty, 34432}};
        const static UnicodeSet::bitquad_t __IDST_set_quads[] = {0x000c0000};
        const static UnicodeSet IDST_set{__IDST_set_runs, 3, __IDST_set_quads, 1};
        static BinaryPropertyObject property_object{IDST, std::move(IDST_set)};
    }
PropertyObject * get_IDST_PropertyObject() {  return & IDST_ns::property_object; }
    namespace IDSU_ns {
        /* Code Point Ranges for IDSU
        [2ffe, 2fff] */

        const static UnicodeSet::run_t __IDSU_set_runs[] = {{Empty, 383}, {Mixed, 1}, {Empty, 34432}};
        const static UnicodeSet::bitquad_t __IDSU_set_quads[] = {0xc0000000};
        const static UnicodeSet IDSU_set{__IDSU_set_runs, 3, __IDSU_set_quads, 1};
        static BinaryPropertyObject property_object{IDSU, std::move(IDSU_set)};
    }
PropertyObject * get_IDSU_PropertyObject() {  return & IDSU_ns::property_object; }
    namespace ID_COMPAT_MATH_CONTINUE_ns {
        /* Code Point Ranges for ID_Compat_Math_Continue
        [00b2, 00b3], [00b9, 00b9], [2070, 2070], [2074, 207e],
        [2080, 208e], [2202, 2202], [2207, 2207], [221e, 221e],
        [1d6c1, 1d6c1], [1d6db, 1d6db], [1d6fb, 1d6fb], [1d715, 1d715],
        [1d735, 1d735], [1d74f, 1d74f], [1d76f, 1d76f], [1d789, 1d789],
        [1d7a9, 1d7a9], [1d7c3, 1d7c3] */

        const static UnicodeSet::run_t __ID_Compat_Math_Continue_set_runs[] = {
        {Empty, 5}, {Mixed, 1}, {Empty, 253}, {Mixed, 2}, {Empty, 11},
        {Mixed, 1}, {Empty, 3493}, {Mixed, 9}, {Empty, 31041}};
        const static UnicodeSet::bitquad_t __ID_Compat_Math_Continue_set_quads[] = {
        0x020c0000, 0x7ff10000, 0x00007fff, 0x40000084, 0x08000002,
        0x08000000, 0x00200000, 0x00200000, 0x00008000, 0x00008000,
        0x00000200, 0x00000200, 0x00000008};
        const static UnicodeSet ID_Compat_Math_Continue_set{__ID_Compat_Math_Continue_set_runs, 9, __ID_Compat_Math_Continue_set_quads, 13};
        static BinaryPropertyObject property_object{ID_Compat_Math_Continue, std::move(ID_Compat_Math_Continue_set)};
    }
PropertyObject * get_ID_COMPAT_MATH_CONTINUE_PropertyObject() {  return & ID_COMPAT_MATH_CONTINUE_ns::property_object; }
    namespace ID_COMPAT_MATH_START_ns {
        /* Code Point Ranges for ID_Compat_Math_Start
        [2202, 2202], [2207, 2207], [221e, 221e], [1d6c1, 1d6c1],
        [1d6db, 1d6db], [1d6fb, 1d6fb], [1d715, 1d715], [1d735, 1d735],
        [1d74f, 1d74f], [1d76f, 1d76f], [1d789, 1d789], [1d7a9, 1d7a9],
        [1d7c3, 1d7c3] */

        const static UnicodeSet::run_t __ID_Compat_Math_Start_set_runs[] = {
        {Empty, 272}, {Mixed, 1}, {Empty, 3493}, {Mixed, 9}, {Empty, 31041}};
        const static UnicodeSet::bitquad_t __ID_Compat_Math_Start_set_quads[] = {
        0x40000084, 0x08000002, 0x08000000, 0x00200000, 0x00200000,
        0x00008000, 0x00008000, 0x00000200, 0x00000200, 0x00000008};
        const static UnicodeSet ID_Compat_Math_Start_set{__ID_Compat_Math_Start_set_runs, 5, __ID_Compat_Math_Start_set_quads, 10};
        static BinaryPropertyObject property_object{ID_Compat_Math_Start, std::move(ID_Compat_Math_Start_set)};
    }
PropertyObject * get_ID_COMPAT_MATH_START_PropertyObject() {  return & ID_COMPAT_MATH_START_ns::property_object; }
    namespace IDEO_ns {
        /* Code Point Ranges for Ideo
        [3006, 3007], [3021, 3029], [3038, 303a], [3400, 4dbf],
        [4e00, 9fff], [f900, fa6d], [fa70, fad9], [16fe4, 16fe4],
        [17000, 187f7], [18800, 18cd5], [18cff, 18d08], [1b170, 1b2fb],
        ...
        {Mixed, 1}, {Empty, 936}, {Mixed, 1}, {Full, 191}, {Mixed, 1},
        {Full, 38}, {Mixed, 3}, {Empty, 290}, {Mixed, 1}, {Full, 11},
        {Mixed, 1}, {Empty, 616}, {Full, 1335}, {Empty, 1}, {Full, 129},
        ...
        0x000000c0, 0x070003fe, 0xffff3fff, 0x03ffffff, 0x00000010,
        0x00ffffff, 0x003fffff, 0x80000000, 0x000001ff, 0xffff0000,
        0x0fffffff, 0x03ffffff, 0x3fffffff, 0xffff0003, 0xffff0001,
        0x3fffffff, 0x3fffffff, 0xffff07ff, 0x0000ffff};
        const static UnicodeSet Ideo_set{__Ideo_set_runs, 43, __Ideo_set_quads, 19};
...
PropertyObject * get_IDEO_PropertyObject() {  return & IDEO_ns::property_object; }
    namespace JOIN_C_ns {
        ...
        const static UnicodeSet::run_t __Join_C_set_runs[] = {{Empty, 256}, {Mixed, 1}, {Empty, 34559}};
        const static UnicodeSet::bitquad_t __Join_C_set_quads[] = {0x00003000};
        const static UnicodeSet Join_C_set{__Join_C_set_runs, 3, __Join_C_set_quads, 1};
        static BinaryPropertyObject property_object{Join_C, std::move(Join_C_set)};
    }
PropertyObject * get_JOIN_C_PropertyObject() {  return & JOIN_C_ns::property_object; }
    namespace LOE_ns {
        ...
        const static UnicodeSet::run_t __LOE_set_runs[] = {
        {Empty, 114}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 86},
        {Mixed, 1}, {Empty, 1159}, {Mixed, 1}, {Empty, 33450}};
        const static UnicodeSet::bitquad_t __LOE_set_quads[] = {
        0x0000001f, 0x0000001f, 0x04e00000, 0x1a600000};
        const static UnicodeSet LOE_set{__LOE_set_runs, 9, __LOE_set_quads, 4};
        static BinaryPropertyObject property_object{LOE, std::move(LOE_set)};
    }
...
PropertyObject * get_MCM_PropertyObject() {  return & MCM_ns::property_object; }
    namespace NCHAR_ns {
        ...
        const static UnicodeSet::run_t __NChar_set_runs[] = {
        ...
        {Empty, 2047}, {Mixed, 1}, {Empty, 2047}, {Mixed, 1}, {Empty, 2047},
        {Mixed, 1}};
        const static UnicodeSet::bitquad_t __NChar_set_quads[] = {
        ...
        const static UnicodeSet NChar_set{__NChar_set_runs, 36, __NChar_set_quads, 19};
        static BinaryPropertyObject property_object{NChar, std::move(NChar_set)};
    }
PropertyObject * get_NCHAR_PropertyObject() {  return & NCHAR_ns::property_object; }
    namespace OALPHA_ns {
        ...
        [0825, 0827], [0829, 082c], [0897, 0897], [08d4, 08df],
        [08e3, 08e9], [08f0, 0903], [093a, 093b], [093e, 094c],
        [094e, 094f], [0955, 0957], [0962, 0963], [0981, 0983],
        [09be, 09c4], [09c7, 09c8], [09cb, 09cc], [09d7, 09d7],
        [09e2, 09e3], [0a01, 0a03], [0a3e, 0a42], [0a47, 0a48],
        [0a4b, 0a4c], [0a51, 0a51], [0a70, 0a71], [0a75, 0a75],
        [0a81, 0a83], [0abe, 0ac5], [0ac7, 0ac9], [0acb, 0acc],
        [0ae2, 0ae3], [0afa, 0afc], [0b01, 0b03], [0b3e, 0b44],
        [0b47, 0b48], [0b4b, 0b4c], [0b56, 0b57], [0b62, 0b63],
        [0b82, 0b82], [0bbe, 0bc2], [0bc6, 0bc8], [0bca, 0bcc],
        [0bd7, 0bd7], [0c00, 0c04], [0c3e, 0c44], [0c46, 0c48],
        [0c4a, 0c4c], [0c55, 0c56], [0c62, 0c63], [0c81, 0c83],
        [0cbe, 0cc4], [0cc6, 0cc8], [0cca, 0ccc], [0cd5, 0cd6],
        [0ce2, 0ce3], [0cf3, 0cf3], [0d00, 0d03], [0d3e, 0d44],
        [0d46, 0d48], [0d4a, 0d4c], [0d57, 0d57], [0d62, 0d63],
        [0d81, 0d83], [0dcf, 0dd4], [0dd6, 0dd6], [0dd8, 0ddf],
        [0df2, 0df3], [0e31, 0e31], [0e34, 0e3a], [0e4d, 0e4d],
        [0eb1, 0eb1], [0eb4, 0eb9], [0ebb, 0ebc], [0ecd, 0ecd],
        [0f71, 0f83], [0f8d, 0f97], [0f99, 0fbc], [102b, 1036],
        [1038, 1038], [103b, 103e], [1056, 1059], [105e, 1060],
        [1062, 1064], [1067, 106d], [1071, 1074], [1082, 108d],
        [108f, 108f], [109a, 109d], [1712, 1713], [1732, 1733],
        [1752, 1753], [1772, 1773], [17b6, 17c8], [1885, 1886],
        [18a9, 18a9], [1920, 192b], [1930, 1938], [1a17, 1a1b],
        [1a55, 1a5e], [1a61, 1a74], [1abf, 1ac0], [1acc, 1ace],
        [1b00, 1b04], [1b35, 1b43], [1b80, 1b82], [1ba1, 1ba9],
        [1bac, 1bad], [1be7, 1bf1], [1c24, 1c36], [1dd3, 1df4],
        ...
        [10d24, 10d27], [10d69, 10d69], [10eab, 10eac], [10efc, 10efc],
        ...
        [1122c, 11234], [11237, 11237], [1123e, 1123e], [11241, 11241],
        [112df, 112e8], [11300, 11303], [1133e, 11344], [11347, 11348],
        [1134b, 1134c], [11357, 11357], [11362, 11363], [113b8, 113c0],
        [113c2, 113c2], [113c5, 113c5], [113c7, 113ca], [113cc, 113cd],
        [11435, 11441], [11443, 11445], [114b0, 114c1], [115af, 115b5],
        [115b8, 115be], [115dc, 115dd], [11630, 1163e], [11640, 11640],
        [116ab, 116b5], [1171d, 1172a], [1182c, 11838], [11930, 11935],
        [11937, 11938], [1193b, 1193c], [11940, 11940], [11942, 11942],
        [119d1, 119d7], [119da, 119df], [119e4, 119e4], [11a01, 11a0a],
        ...
        [11d43, 11d43], [11d47, 11d47], [11d8a, 11d8e], [11d90, 11d91],
        [11d93, 11d96], [11ef3, 11ef6], [11f00, 11f01], [11f03, 11f03],
        [11f34, 11f3a], [11f3e, 11f40], [1611e, 1612e], [16f4f, 16f4f],
        [16f51, 16f87], [16f8f, 16f92], [16ff0, 16ff1], [1bc9e, 1bc9e],
        [1e000, 1e006], [1e008, 1e018], [1e01b, 1e021], [1e023, 1e024],
        [1e026, 1e02a], [1e08f, 1e08f], [1e947, 1e947], [1f130, 1f149],
        ...
        {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 2},
        {Mixed, 2}, {Empty, 4}, {Mixed, 3}, {Empty, 3}, {Mixed, 4},
        {Empty, 51}, {Mixed, 4}, {Empty, 1}, {Mixed, 2}, {Empty, 5},
        {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Empty, 6}, {Mixed, 1},
        {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 1},
        {Mixed, 3}, {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 1},
        {Empty, 1}, {Mixed, 1}, {Empty, 12}, {Mixed, 2}, {Empty, 53},
        {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Empty, 71}, {Full, 1},
        {Empty, 963}, {Mixed, 2}, {Empty, 11}, {Mixed, 2}, {Empty, 2},
        {Mixed, 4}, {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 2},
        ...
        {Mixed, 4}, {Empty, 525}, {Mixed, 2}, {Empty, 112}, {Mixed, 1},
        {Full, 1}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 612},
        {Mixed, 1}, {Empty, 283}, {Mixed, 2}, {Empty, 2}, {Mixed, 1},
        {Empty, 69}, {Mixed, 1}, {Empty, 62}, {Mixed, 4}, {Empty, 30835}};
        ...
        0x0000000c, 0x0000000e, 0xc0000000, 0x0080199f, 0x0000000c,
        0x0000000e, 0xc0000000, 0x00021987, 0x00230000, 0x0000000e,
        0xc0000000, 0x00001bbf, 0x1c00000c, 0x0000000e, 0xc0000000,
        0x00c0199f, 0x0000000c, 0x00000004, 0xc0000000, 0x00801dc7,
        0x0000001f, 0xc0000000, 0x00601ddf, 0x0000000c, 0x0000000e,
        0xc0000000, 0x00601ddf, 0x0008000c, 0x0000000f, 0xc0000000,
        0x00801ddf, 0x0000000c, 0x0000000e, 0xff5f8000, 0x000c0000,
        0x07f20000, 0x00002000, 0x1bf20000, 0x00002000, 0xfffe0000,
        0xfeffe00f, 0x1fffffff, 0x797ff800, 0xc3c00000, 0x001e3f9d,
        0x3c00bffc, 0x000c0000, 0x000c0000, 0x000c0000, 0x000c0000,
        0xffc00000, 0x000001ff, 0x00000060, 0x00000200, 0x01ff0fff,
        0x0f800000, 0x7fe00000, 0x001ffffe, 0x80000000, 0x00007001,
        0x0000001f, 0xffe00000, 0x0000000f, 0x00000007, 0x000033fe,
        0x0003ff80, 0x007ffff0, 0xfff80000, 0x001fffff, 0xffc00000,
        0x000003ff, 0x0ff00000, 0xc0000000, 0x00000804, 0x000000f8,
        0x00000003, 0xfff00000, 0x0000002f, 0x80000000, 0x000007c0,
        ...
        0x00001800, 0x10000000, 0x00000007, 0xff000000, 0x0000003f,
        ...
        0x007b7c00, 0x00780000, 0x0000000b, 0xc7f00000, 0x00000001,
        0xc0000000, 0x00007fff, 0xfffe8000, 0x000780ff, 0x00030000,
        0x40000000, 0xf9ffff7f, 0x000007db, 0x00008000, 0x00000080,
        0xffff0000, 0xffff03ff, 0xffff03ff, 0x000003ff};
        const static UnicodeSet OAlpha_set{__OAlpha_set_runs, 155, __OAlpha_set_quads, 184};
...
PropertyObject * get_OALPHA_PropertyObject() {  return & OALPHA_ns::property_object; }
    namespace ODI_ns {
        ...
        const static UnicodeSet::run_t __ODI_set_runs[] = {
        ...
        {Full, 112}, {Empty, 6016}};
        const static UnicodeSet::bitquad_t __ODI_set_quads[] = {
        0x00008000, 0x80000000, 0x00000001, 0x00300000, 0x00000020,
        0x00000010, 0x00000001, 0x01ff0000, 0xfffffffd, 0xffff0000};
        const static UnicodeSet ODI_set{__ODI_set_runs, 22, __ODI_set_quads, 10};
        static BinaryPropertyObject property_object{ODI, std::move(ODI_set)};
    }
PropertyObject * get_ODI_PropertyObject() {  return & ODI_ns::property_object; }
    namespace OGR_EXT_ns {
        ...
        [0bbe, 0bbe], [0bd7, 0bd7], [0cc0, 0cc0], [0cc2, 0cc2],
        [0cc7, 0cc8], [0cca, 0ccb], [0cd5, 0cd6], [0d3e, 0d3e],
        [0d57, 0d57], [0dcf, 0dcf], [0ddf, 0ddf], [1715, 1715],
        [1734, 1734], [1b35, 1b35], [1b3b, 1b3b], [1b3d, 1b3d],
        [1b43, 1b44], [1baa, 1baa], [1bf2, 1bf3], [200c, 200c],
        [302e, 302f], [a953, a953], [a9c0, a9c0], [ff9e, ff9f],
        [111c0, 111c0], [11235, 11235], [1133e, 1133e], [1134d, 1134d],
        [11357, 11357], [113b8, 113b8], [113c2, 113c2], [113c5, 113c5],
        ...
        {Empty, 3}, {Mixed, 1}, {Empty, 73}, {Mixed, 2}, {Empty, 31},
        {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
        {Empty, 32}, {Mixed, 1}, {Empty, 128}, {Mixed, 1}, {Empty, 968},
        {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 685}, {Mixed, 1},
        {Empty, 145}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 7},
        ...
        0x00200000, 0x00100000, 0x28200000, 0x00000018, 0x00000400,
...
PropertyObject * get_OGR_EXT_PropertyObject() {  return & OGR_EXT_ns::property_object; }
    namespace OIDC_ns {
        ...
        [200c, 200d], [30fb, 30fb], [ff65, ff65] */

        const static UnicodeSet::run_t __OIDC_set_runs[] = {
        {Empty, 5}, {Mixed, 1}, {Empty, 22}, {Mixed, 1}, {Empty, 126},
        {Mixed, 1}, {Empty, 50}, {Mixed, 1}, {Empty, 49}, {Mixed, 1},
        {Empty, 134}, {Mixed, 1}, {Empty, 1651}, {Mixed, 1}, {Empty, 32772}};
        const static UnicodeSet::bitquad_t __OIDC_set_quads[] = {
        0x00800000, 0x00000080, 0x0003fe00, 0x04000000, 0x00003000,
        0x08000000, 0x00000020};
        const static UnicodeSet OIDC_set{__OIDC_set_runs, 15, __OIDC_set_quads, 7};
        static BinaryPropertyObject property_object{OIDC, std::move(OIDC_set)};
    }
PropertyObject * get_OIDC_PropertyObject() {  return & OIDC_ns::property_object; }
    namespace OIDS_ns {
        ...
        const static UnicodeSet::run_t __OIDS_set_runs[] = {
        {Empty, 196}, {Mixed, 1}, {Empty, 67}, {Mixed, 2}, {Empty, 122},
        {Mixed, 1}, {Empty, 34427}};
        const static UnicodeSet::bitquad_t __OIDS_set_quads[] = {
        0x00000060, 0x01000000, 0x00004000, 0x18000000};
        const static UnicodeSet OIDS_set{__OIDS_set_runs, 7, __OIDS_set_quads, 4};
        static BinaryPropertyObject property_object{OIDS, std::move(OIDS_set)};
    }
PropertyObject * get_OIDS_PropertyObject() {  return & OIDS_ns::property_object; }
    namespace OLOWER_ns {
        ...
        [2c7c, 2c7d], [a69c, a69d], [a770, a770], [a7f2, a7f4],
        ...
        0x30000000, 0x30000000, 0x00010000, 0x031c0000, 0xf0000000,
...
PropertyObject * get_OMATH_PropertyObject() {  return & OMATH_ns::property_object; }
    namespace OUPPER_ns {
        ...
        const static UnicodeSet::run_t __OUpper_set_runs[] = {
        {Empty, 267}, {Mixed, 1}, {Empty, 25}, {Mixed, 2}, {Empty, 3682},
        {Mixed, 4}, {Empty, 30835}};
        const static UnicodeSet::bitquad_t __OUpper_set_quads[] = {
        0x0000ffff, 0xffc00000, 0x0000ffff, 0xffff0000, 0xffff03ff,
        0xffff03ff, 0x000003ff};
        const static UnicodeSet OUpper_set{__OUpper_set_runs, 7, __OUpper_set_quads, 7};
        static BinaryPropertyObject property_object{OUpper, std::move(OUpper_set)};
    }
PropertyObject * get_OUPPER_PropertyObject() {  return & OUPPER_ns::property_object; }
    namespace PCM_ns {
        /* Code Point Ranges for PCM
        [0600, 0605], [06dd, 06dd], [070f, 070f], [0890, 0891],
        [08e2, 08e2], [110bd, 110bd], [110cd, 110cd] */

        const static UnicodeSet::run_t __PCM_set_runs[] = {
        {Empty, 48}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 1},
        {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
        {Empty, 2109}, {Mixed, 2}, {Empty, 32633}};
        const static UnicodeSet::bitquad_t __PCM_set_quads[] = {
        0x0000003f, 0x20000000, 0x00008000, 0x00030000, 0x00000004,
        0x20000000, 0x00002000};
        const static UnicodeSet PCM_set{__PCM_set_runs, 13, __PCM_set_quads, 7};
        static BinaryPropertyObject property_object{PCM, std::move(PCM_set)};
    }
PropertyObject * get_PCM_PropertyObject() {  return & PCM_ns::property_object; }
    namespace PAT_SYN_ns {
        ...
        const static UnicodeSet::run_t __Pat_Syn_set_runs[] = {
        ...
        {Mixed, 1}, {Empty, 32781}};
        const static UnicodeSet::bitquad_t __Pat_Syn_set_quads[] = {
        ...
        0x00000060};
        const static UnicodeSet Pat_Syn_set{__Pat_Syn_set_runs, 22, __Pat_Syn_set_quads, 16};
        static BinaryPropertyObject property_object{Pat_Syn, std::move(Pat_Syn_set)};
    }
PropertyObject * get_PAT_SYN_PropertyObject() {  return & PAT_SYN_ns::property_object; }
    namespace PAT_WS_ns {
        ...
        const static UnicodeSet::run_t __Pat_WS_set_runs[] = {
        {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Empty, 251}, {Mixed, 2},
        {Empty, 34558}};
        const static UnicodeSet::bitquad_t __Pat_WS_set_quads[] = {
        0x00003e00, 0x00000001, 0x00000020, 0x0000c000, 0x00000300};
        const static UnicodeSet Pat_WS_set{__Pat_WS_set_runs, 6, __Pat_WS_set_quads, 5};
        static BinaryPropertyObject property_object{Pat_WS, std::move(Pat_WS_set)};
    }
PropertyObject * get_PAT_WS_PropertyObject() {  return & PAT_WS_ns::property_object; }
    namespace QMARK_ns {
        ...
        const static UnicodeSet::run_t __QMark_set_runs[] = {
        ...
        {Mixed, 1}, {Empty, 32772}};
        const static UnicodeSet::bitquad_t __QMark_set_quads[] = {
        0x00000084, 0x08000800, 0xff000000, 0x06000000, 0x00000004,
        0xe000f000, 0x0000001e, 0x00000084, 0x0000000c};
        const static UnicodeSet QMark_set{__QMark_set_runs, 17, __QMark_set_quads, 9};
        static BinaryPropertyObject property_object{QMark, std::move(QMark_set)};
    }
PropertyObject * get_QMARK_PropertyObject() {  return & QMARK_ns::property_object; }
    namespace RI_ns {
        ...
        static BinaryPropertyObject property_object{RI, std::move(RI_set)};
    }
PropertyObject * get_RI_PropertyObject() {  return & RI_ns::property_object; }
    namespace RADICAL_ns {
        ...
        const static UnicodeSet::run_t __Radical_set_runs[] = {
        {Empty, 372}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 6},
        {Mixed, 1}, {Empty, 34433}};
        const static UnicodeSet::bitquad_t __Radical_set_quads[] = {0xfbffffff, 0x000fffff, 0x003fffff};
        const static UnicodeSet Radical_set{__Radical_set_runs, 7, __Radical_set_quads, 3};
        static BinaryPropertyObject property_object{Radical, std::move(Radical_set)};
    }
...
PropertyObject * get_SD_PropertyObject() {  return & SD_ns::property_object; }
    namespace STERM_ns {
        ...
        [061d, 061f], [06d4, 06d4], [0700, 0702], [07f9, 07f9],
        [0837, 0837], [0839, 0839], [083d, 083e], [0964, 0965],
        [104a, 104b], [1362, 1362], [1367, 1368], [166e, 166e],
        [1735, 1736], [17d4, 17d5], [1803, 1803], [1809, 1809],
        ...
        {Empty, 23}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 4},
        ...
        {Empty, 3}, {Mixed, 1}, {Empty, 4}, {Mixed, 1}, {Empty, 7},
        {Mixed, 1}, {Empty, 656}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
        {Empty, 5}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 86},
        {Mixed, 1}, {Empty, 39}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
        {Empty, 5}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 3},
        {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
        {Empty, 3}, {Mixed, 1}, {Empty, 8}, {Mixed, 1}, {Empty, 3},
        {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
        {Empty, 6}, {Mixed, 1}, {Empty, 16}, {Mixed, 1}, {Empty, 7},
        {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 13}, {Mixed, 1},
        {Empty, 20}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 600},
        {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
        {Empty, 16}, {Mixed, 1}, {Empty, 8}, {Mixed, 1}, {Empty, 623},
        {Mixed, 1}, {Empty, 239}, {Mixed, 1}, {Empty, 31019}};
        const static UnicodeSet::bitquad_t __STerm_set_quads[] = {
        0x80004002, 0x00000200, 0xe0000000, 0x00100000, 0x00000007,
...
PropertyObject * get_STERM_PropertyObject() {  return & STERM_ns::property_object; }
    namespace TERM_ns {
        ...
        [05c3, 05c3], [060c, 060c], [061b, 061b], [061d, 061f],
        [06d4, 06d4], [0700, 070a], [070c, 070c], [07f8, 07f9],
        [0830, 0835], [0837, 083e], [085e, 085e], [0964, 0965],
        [0e5a, 0e5b], [0f08, 0f08], [0f0d, 0f12], [104a, 104b],
        [1361, 1368], [166e, 166e], [16eb, 16ed], [1735, 1736],
        [17d4, 17d6], [17da, 17da], [1802, 1805], [1808, 1809],
        [1944, 1945], [1aa8, 1aab], [1b4e, 1b4f], [1b5a, 1b5b],
        ...
        {Empty, 6}, {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 2},
        {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 4}, {Mixed, 1},
        {Empty, 3}, {Mixed, 1}, {Empty, 3}, {Mixed, 2}, {Empty, 7},
        {Mixed, 1}, {Empty, 656}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
        {Empty, 5}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 32},
        {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 35}, {Mixed, 1},
        {Empty, 5}, {Mixed, 1}, {Empty, 9}, {Mixed, 1}, {Empty, 4},
        {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
        {Empty, 29}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 5},
        {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 3}, {Mixed, 1},
        {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 3},
        {Mixed, 1}, {Empty, 8}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
        ...
        const static UnicodeSet::bitquad_t __Term_set_quads[] = {
        0x8c005002, 0x40000000, 0x00000080, 0x00000200, 0x00000008,
        0xe8001000, 0x00100000, 0x000017ff, 0x03000000, 0x7fbf0000,
...
PropertyObject * get_TERM_PropertyObject() {  return & TERM_ns::property_object; }
    namespace UIDEO_ns {
        ...
        [fa27, fa29], [20000, 2a6df], [2a700, 2b739], [2b740, 2b81d],
        [2b820, 2cea1], [2ceb0, 2ebe0], [2ebf0, 2ee5d], [30000, 3134a],
        [31350, 323af] */

        const static UnicodeSet::run_t __UIdeo_set_runs[] = {
        {Empty, 416}, {Full, 206}, {Empty, 2}, {Full, 656}, {Empty, 720},
        {Mixed, 2}, {Empty, 2094}, {Full, 1335}, {Empty, 1}, {Full, 129},
        {Mixed, 1}, {Full, 6}, {Mixed, 1}, {Full, 180}, {Mixed, 1},
        {Full, 233}, {Mixed, 1}, {Full, 18}, {Mixed, 1}, {Empty, 141},
        {Full, 154}, {Mixed, 1}, {Full, 130}, {Mixed, 1}, {Empty, 28386}};
        const static UnicodeSet::bitquad_t __UIdeo_set_quads[] = {
        0x801ac000, 0x0000039a, 0x03ffffff, 0x3fffffff, 0xffff0003,
        0xffff0001, 0x3fffffff, 0xffff07ff, 0x0000ffff};
        const static UnicodeSet UIdeo_set{__UIdeo_set_runs, 25, __UIdeo_set_quads, 9};
...
PropertyObject * get_UIDEO_PropertyObject() {  return & UIDEO_ns::property_object; }
    namespace VS_ns {
        ...
        [180b, 180d], [180f, 180f], [fe00, fe0f], [e0100, e01ef] */

        const static UnicodeSet::run_t __VS_set_runs[] = {
        {Empty, 192}, {Mixed, 1}, {Empty, 1839}, {Mixed, 1}, {Empty, 26647},
        {Full, 7}, {Mixed, 1}, {Empty, 6128}};
        const static UnicodeSet::bitquad_t __VS_set_quads[] = {0x0000b800, 0x0000ffff, 0x0000ffff};
        const static UnicodeSet VS_set{__VS_set_runs, 8, __VS_set_quads, 3};
        static BinaryPropertyObject property_object{VS, std::move(VS_set)};
    }
PropertyObject * get_VS_PropertyObject() {  return & VS_ns::property_object; }
    namespace WSPACE_ns {
        ...
        const static UnicodeSet::run_t __WSpace_set_runs[] = {
        {Mixed, 2}, {Empty, 2}, {Mixed, 2}, {Empty, 174}, {Mixed, 1},
        {Empty, 75}, {Mixed, 3}, {Empty, 125}, {Mixed, 1}, {Empty, 34431}};
        const static UnicodeSet::bitquad_t __WSpace_set_quads[] = {
        0x00003e00, 0x00000001, 0x00000020, 0x00000001, 0x00000001,
        0x000007ff, 0x00008300, 0x80000000, 0x00000001};
        const static UnicodeSet WSpace_set{__WSpace_set_runs, 10, __WSpace_set_quads, 9};
        static BinaryPropertyObject property_object{WSpace, std::move(WSpace_set)};
    }
