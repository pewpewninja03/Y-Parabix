...
PropertyObject * get_DEP_PropertyObject() {  return & DEP_ns::property_object; }
    namespace DIA_ns {
        ...
        [1134d, 1134d], [11366, 1136c], [11370, 11374], [113ce, 113d0],
        [113d2, 113d3], [113e1, 113e2], [11442, 11442], [11446, 11446],
        [114c2, 114c3], [115bf, 115c0], [1163f, 1163f], [116b6, 116b7],
        [1172b, 1172b], [11839, 1183a], [1193d, 1193e], [11943, 11943],
        [119e0, 119e0], [11a34, 11a34], [11a47, 11a47], [11a99, 11a99],
        [11c3f, 11c3f], [11d42, 11d42], [11d44, 11d45], [11d97, 11d97],
        [11dd9, 11dd9], [11f41, 11f42], [11f5a, 11f5a], [13447, 13455],
        [1612f, 1612f], [16af0, 16af4], [16b30, 16b36], [16d6b, 16d6c],
        ...
        {Empty, 9}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Empty, 1},
...
PropertyObject * get_DIA_PropertyObject() {  return & DIA_ns::property_object; }
    namespace EXT_ns {
        ...
        [113d2, 113d3], [115c6, 115c8], [11a98, 11a98], [11dd9, 11dd9],
        [16b42, 16b43], [16fe0, 16fe1], [16fe3, 16fe3], [16ff2, 16ff3],
        [1e13c, 1e13d], [1e5ef, 1e5ef], [1e944, 1e946] */
        ...
        {Empty, 25}, {Mixed, 1}, {Empty, 619}, {Mixed, 1}, {Empty, 36},
        {Mixed, 1}, {Empty, 905}, {Mixed, 1}, {Empty, 37}, {Mixed, 1},
        ...
        0x20000000, 0x000c0000, 0x000001c0, 0x01000000, 0x02000000,
        0x0000000c, 0x000c000b, 0x30000000, 0x00008000, 0x00000070};
        const static UnicodeSet Ext_set{__Ext_set_runs, 73, __Ext_set_quads, 40};
...
PropertyObject * get_TERM_PropertyObject() {  return & TERM_ns::property_object; }
    namespace UIDEO_ns {
        ...
        {Mixed, 2}, {Empty, 2094}, {Full, 1335}, {Empty, 1}, {Full, 136},
