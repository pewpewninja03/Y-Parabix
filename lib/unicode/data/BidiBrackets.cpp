...
namespace UCD {
    namespace BPB_ns {
        ...
        const static UnicodeSet null_codepoint_set{const_cast<UnicodeSet::run_t *>(__null_codepoint_set_runs), 27, 0, const_cast<UnicodeSet::bitquad_t *>(__null_codepoint_set_quads), 24, 0};
        ...
        **/
        ...
        {0x0028, 0x0029}, {0x0029, 0x0028}, {0x005b, 0x005d},
        {0x005d, 0x005b}, {0x007b, 0x007d}, {0x007d, 0x007b},
        {0x0f3a, 0x0f3b}, {0x0f3b, 0x0f3a}, {0x0f3c, 0x0f3d},
        {0x0f3d, 0x0f3c}, {0x169b, 0x169c}, {0x169c, 0x169b},
        {0x2045, 0x2046}, {0x2046, 0x2045}, {0x207d, 0x207e},
        {0x207e, 0x207d}, {0x208d, 0x208e}, {0x208e, 0x208d},
        {0x2308, 0x2309}, {0x2309, 0x2308}, {0x230a, 0x230b},
        {0x230b, 0x230a}, {0x2329, 0x232a}, {0x232a, 0x2329},
        {0x2768, 0x2769}, {0x2769, 0x2768}, {0x276a, 0x276b},
        {0x276b, 0x276a}, {0x276c, 0x276d}, {0x276d, 0x276c},
        {0x276e, 0x276f}, {0x276f, 0x276e}, {0x2770, 0x2771},
        {0x2771, 0x2770}, {0x2772, 0x2773}, {0x2773, 0x2772},
        {0x2774, 0x2775}, {0x2775, 0x2774}, {0x27c5, 0x27c6},
        {0x27c6, 0x27c5}, {0x27e6, 0x27e7}, {0x27e7, 0x27e6},
        {0x27e8, 0x27e9}, {0x27e9, 0x27e8}, {0x27ea, 0x27eb},
        {0x27eb, 0x27ea}, {0x27ec, 0x27ed}, {0x27ed, 0x27ec},
        {0x27ee, 0x27ef}, {0x27ef, 0x27ee}, {0x2983, 0x2984},
        {0x2984, 0x2983}, {0x2985, 0x2986}, {0x2986, 0x2985},
        {0x2987, 0x2988}, {0x2988, 0x2987}, {0x2989, 0x298a},
        {0x298a, 0x2989}, {0x298b, 0x298c}, {0x298c, 0x298b},
        {0x298d, 0x2990}, {0x298e, 0x298f}, {0x298f, 0x298e},
        {0x2990, 0x298d}, {0x2991, 0x2992}, {0x2992, 0x2991},
        {0x2993, 0x2994}, {0x2994, 0x2993}, {0x2995, 0x2996},
        {0x2996, 0x2995}, {0x2997, 0x2998}, {0x2998, 0x2997},
        {0x29d8, 0x29d9}, {0x29d9, 0x29d8}, {0x29da, 0x29db},
        {0x29db, 0x29da}, {0x29fc, 0x29fd}, {0x29fd, 0x29fc},
        {0x2e22, 0x2e23}, {0x2e23, 0x2e22}, {0x2e24, 0x2e25},
        {0x2e25, 0x2e24}, {0x2e26, 0x2e27}, {0x2e27, 0x2e26},
...
PropertyObject * get_BPB_PropertyObject() {  return & BPB_ns::property_object; }
  namespace BPT_ns {
    ...
    const static UnicodeSet n_Set{const_cast<UnicodeSet::run_t *>(__n_Set_runs), 27, 0, const_cast<UnicodeSet::bitquad_t *>(__n_Set_quads), 24, 0};
    ...
    const static UnicodeSet o_Set{const_cast<UnicodeSet::run_t *>(__o_Set_runs), 27, 0, const_cast<UnicodeSet::bitquad_t *>(__o_Set_quads), 24, 0};
    ...
    const static UnicodeSet c_Set{const_cast<UnicodeSet::run_t *>(__c_Set_runs), 27, 0, const_cast<UnicodeSet::bitquad_t *>(__c_Set_quads), 24, 0};
