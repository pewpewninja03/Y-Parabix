...
namespace UCD {
  namespace DT_ns {
    ...
    const static UnicodeSet none_Set{const_cast<UnicodeSet::run_t *>(__none_Set_runs), 194, 0, const_cast<UnicodeSet::bitquad_t *>(__none_Set_quads), 187, 0};
    ...
    const static UnicodeSet can_Set{const_cast<UnicodeSet::run_t *>(__can_Set_runs), 105, 0, const_cast<UnicodeSet::bitquad_t *>(__can_Set_quads), 98, 0};
    ...
    const static UnicodeSet font_Set{const_cast<UnicodeSet::run_t *>(__font_Set_runs), 23, 0, const_cast<UnicodeSet::bitquad_t *>(__font_Set_quads), 22, 0};
    ...
    const static UnicodeSet sup_Set{const_cast<UnicodeSet::run_t *>(__sup_Set_runs), 36, 0, const_cast<UnicodeSet::bitquad_t *>(__sup_Set_quads), 24, 0};
    ...
    const static UnicodeSet sub_Set{const_cast<UnicodeSet::run_t *>(__sub_Set_runs), 9, 0, const_cast<UnicodeSet::bitquad_t *>(__sub_Set_quads), 5, 0};
