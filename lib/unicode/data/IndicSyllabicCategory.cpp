...
namespace UCD {
  namespace INSC_ns {
    ...
    [0e46, 0e46], [0e4f, 0e4f], [0e5a, 0e80], [0e83, 0e83], [0e85, 0e85],
    [0e8b, 0e8b], [0ea4, 0ea4], [0ea6, 0ea6], [0eaf, 0eaf], [0ebe, 0ebf],
    [0ec5, 0ec7], [0ecc, 0ecc], [0ecf, 0ecf], [0eda, 0edb], [0ee0, 0f1f],
    [0f34, 0f34], [0f36, 0f36], [0f38, 0f38], [0f3a, 0f3f], [0f48, 0f48],
    [0f6d, 0f70], [0f86, 0f87], [0f98, 0f98], [0fbd, 0fc5], [0fc7, 0fff],
    [104a, 104a], [104c, 104d], [104f, 104f], [109e, 16ff], [1716, 171e],
    ...
    [1a8a, 1a8f], [1a9a, 1aff], [1b4d, 1b4f], [1b5a, 1b7f], [1bf4, 1bff],
    ...
    [11047, 11051], [11076, 1107e], [110bb, 110c1], [110c3, 110ff],
    [11135, 11135], [11140, 11143], [11148, 1114f], [11174, 1117f],
    [111c4, 111c8], [111cd, 111cd], [111da, 111e0], [111f5, 111ff],
    ...
    [1133a, 1133a], [11345, 11346], [11349, 1134a], [1134e, 11356],
    [11358, 1135d], [11364, 11365], [1136d, 1136f], [11375, 1137f],
    [1138a, 1138a], [1138c, 1138d], [1138f, 1138f], [113b6, 113b6],
    [113c1, 113c1], [113c3, 113c4], [113c6, 113c6], [113cb, 113cb],
    [113d3, 113e0], [113e3, 113ff], [11448, 1144f], [1145a, 1145d],
    [11462, 11480], [114c5, 114cf], [114da, 1157f], [115b6, 115b7],
    [115c1, 115d7], [115de, 115ff], [11641, 1164f], [1165a, 1167f],
    [116b9, 116bf], [116ca, 116cf], [116e4, 116ff], [1171b, 1171c],
    [1172c, 1172f], [1173c, 1173f], [11747, 117ff], [1183b, 118ff],
    ...
    [11a9e, 11bff], [11c09, 11c09], [11c37, 11c37], [11c41, 11c4f],
    [11c6d, 11c71], [11c90, 11c91], [11ca8, 11ca8], [11cb7, 11cff],
    ...
    {Full, 45}, {Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Full, 1},
    {Empty, 1}, {Mixed, 3}, {Empty, 2}, {Mixed, 5}, {Full, 1}, {Mixed, 2},
    {Empty, 1}, {Mixed, 9}, {Empty, 2}, {Mixed, 3}, {Empty, 1}, {Mixed, 1},
    ...
    0xfc008040, 0x00000829, 0xc0008050, 0x0c0090e0, 0xfd500000, 0x00000100,
    0x0001e000, 0x010000c0, 0xe0000000, 0xffffffbf, 0x0000b400, 0xc0000000,
    0x7fc00000, 0xffe00000, 0xfff00000, 0xfff22000, 0x00300000, 0xcff00000,
    0xfffffc00, 0x80000000, 0xf000f000, 0x0000003f, 0xffe0c000, 0x0000f000,
    0xf800fc00, 0xf0000000, 0x80000000, 0x60000000, 0xfc00fc00, 0xfc00e000,
    ...
    0xfc00c800, 0x01100f90, 0x78c00000, 0xfffffe00, 0x0003ff80, 0x7fc00000,
    0xf8000000, 0xfffffffb, 0x00200000, 0x0000ff0f, 0xfff00000, 0xfc0021f0,
    0xffe00001, 0x00040000, 0x3f000000, 0xfffffffc, 0x40004280, 0x0000fe00,
    0xfc00f800, 0x00066010, 0x04120200, 0x3f7fc660, 0xffe0e030, 0x0000b400,
    0x00400000, 0xfff8085a, 0xfffffff9, 0x3c00ff00, 0xfffffffc, 0x00000001,
    ...
    0xdc000000, 0x00000200, 0x00800000, 0x0000fffe, 0x0003e000, 0x00030000,
    0xff800100, 0x00000480, 0x4b800000, 0xfc00ff00, 0x00000240, 0xff048000,
    0xfffffc00, 0xff800000, 0x00020000, 0x38000000, 0xf800fff8, 0xfc000000,
    0xfc00e000};
    }

    const static UnicodeSet other_Set{const_cast<UnicodeSet::run_t *>(__other_Set_runs), 122, 0, const_cast<UnicodeSet::bitquad_t *>(__other_Set_quads), 163, 0};
    ...
    [0c80, 0c82], [0cf3, 0cf3], [0d00, 0d02], [0d04, 0d04], [0d81, 0d82],
    [0e4d, 0e4d], [0ecd, 0ecd], [0f7e, 0f7e], [0f82, 0f83], [1036, 1036],
    [17c6, 17c6], [1932, 1932], [1a74, 1a74], [1b00, 1b02], [1b80, 1b80],
    [1c34, 1c35], [a80b, a80b], [a873, a873], [a880, a880], [a8c5, a8c5],
    [a8f2, a8f3], [a980, a981], [10a0e, 10a0e], [11000, 11001],
    [11080, 11081], [11100, 11101], [11180, 11181], [111cf, 111cf],
    [11234, 11234], [112df, 112df], [11300, 11302], [1135e, 1135f],
    [113ca, 113ca], [113cc, 113cc], [11443, 11444], [1145f, 1145f],
    ...
    {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 6}, {Mixed, 1},
    ...
    0x00000040, 0x00040000, 0x00100000, 0x00000007, 0x00000001, 0x00300000,
    0x00000800, 0x00080000, 0x00000001, 0x00000020, 0x000c0000, 0x00000003,
    0x00004000, 0x00000003, 0x00000003, 0x00000003, 0x00000003, 0x00008000,
    ...
    const static UnicodeSet bindu_Set{const_cast<UnicodeSet::run_t *>(__bindu_Set_runs), 105, 0, const_cast<UnicodeSet::bitquad_t *>(__bindu_Set_quads), 59, 0};
    ...
    {Empty, 3}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
    {Empty, 11}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
    {Empty, 3}, {Mixed, 1}, {Empty, 6}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
    {Empty, 3}, {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 12},
    ...
    0x00000004, 0x00000004, 0x00000004, 0x00000004, 0x00000008, 0x00002000,
    ...
    const static UnicodeSet visarga_Set{const_cast<UnicodeSet::run_t *>(__visarga_Set_runs), 77, 0, const_cast<UnicodeSet::bitquad_t *>(__visarga_Set_quads), 38, 0};
    ...
    const static UnicodeSet avagraha_Set{const_cast<UnicodeSet::run_t *>(__avagraha_Set_runs), 37, 0, const_cast<UnicodeSet::bitquad_t *>(__avagraha_Set_quads), 18, 0};
    ...
    [1be6, 1be6], [1c37, 1c37], [a9b3, a9b3], [10a38, 10a3a],
    ...
    {Empty, 7}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 19}, {Mixed, 1},
    {Empty, 95}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
    ...
    const static UnicodeSet nukta_Set{const_cast<UnicodeSet::run_t *>(__nukta_Set_runs), 57, 0, const_cast<UnicodeSet::bitquad_t *>(__nukta_Set_quads), 28, 0};
    ...
    {Mixed, 1}, {Empty, 1123}, {Mixed, 1}, {Empty, 8}, {Mixed, 1},
    {Empty, 20}, {Mixed, 1}, {Empty, 803}, {Mixed, 1}, {Empty, 5},
    ...
    const static UnicodeSet pure_killer_Set{const_cast<UnicodeSet::run_t *>(__pure_killer_Set_runs), 47, 0, const_cast<UnicodeSet::bitquad_t *>(__pure_killer_Set_quads), 25, 0};
    ...
    const static UnicodeSet reordering_killer_Set{const_cast<UnicodeSet::run_t *>(__reordering_killer_Set_runs), 3, 0, const_cast<UnicodeSet::bitquad_t *>(__reordering_killer_Set_quads), 1, 0};
    ...
    {Empty, 761}, {Mixed, 1}, {Empty, 55}, {Mixed, 1}, {Empty, 20},
    ...
    const static UnicodeSet invisible_stacker_Set{const_cast<UnicodeSet::run_t *>(__invisible_stacker_Set_runs), 29, 0, const_cast<UnicodeSet::bitquad_t *>(__invisible_stacker_Set_quads), 14, 0};
    ...
    [11005, 11012], [11071, 11072], [11083, 1108c], [11103, 11106],
    [11183, 11190], [11200, 11207], [11240, 11240], [11280, 11283],
    [112b0, 112b9], [11305, 1130c], [1130f, 11310], [11313, 11314],
    [11360, 11361], [11380, 11389], [1138b, 1138b], [1138e, 1138e],
    [11390, 11391], [11400, 1140d], [11481, 1148e], [11580, 1158d],
    [115d8, 115db], [11600, 1160d], [11680, 11689], [11800, 11809],
    ...
    {Empty, 2}, {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
    {Empty, 3}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
    {Empty, 2}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 3}, {Mixed, 1},
    ...
    0x0007ffe0, 0x00060000, 0x00001ff8, 0x00000078, 0x0001fff8, 0x000000ff,
    ...
    const static UnicodeSet vowel_independent_Set{const_cast<UnicodeSet::run_t *>(__vowel_independent_Set_runs), 99, 0, const_cast<UnicodeSet::bitquad_t *>(__vowel_independent_Set_quads), 64, 0};
    ...
    [11038, 11045], [11073, 11074], [110b0, 110b8], [110c2, 110c2],
    [11127, 11132], [11145, 11146], [111b3, 111bf], [111cb, 111cc],
    [111ce, 111ce], [1122c, 11233], [11241, 11241], [112e0, 112e8],
    [1133e, 11344], [11347, 11348], [1134b, 1134c], [11357, 11357],
    [11362, 11363], [113b8, 113c0], [113c2, 113c2], [113c5, 113c5],
    [113c7, 113c9], [11435, 11441], [114b0, 114be], [115af, 115b5],
    [115b8, 115bb], [115dc, 115dd], [11630, 1163c], [11640, 11640],
    [116ad, 116b5], [11720, 1172a], [1182c, 11836], [11930, 11935],
    [11937, 11938], [119d1, 119d7], [119da, 119dd], [119e4, 119e4],
    [11a01, 11a0a], [11a51, 11a5b], [11c2f, 11c36], [11c38, 11c3b],
    ...
    {Mixed, 1}, {Empty, 752}, {Mixed, 1}, {Empty, 48}, {Mixed, 3},
    {Empty, 1}, {Mixed, 2}, {Empty, 2}, {Mixed, 2}, {Empty, 2}, {Mixed, 2},
    {Empty, 2}, {Mixed, 2}, {Empty, 4}, {Mixed, 1}, {Empty, 1}, {Mixed, 3},
    {Empty, 1}, {Mixed, 2}, {Empty, 2}, {Mixed, 2}, {Empty, 2}, {Mixed, 1},
    {Empty, 7}, {Mixed, 2}, {Empty, 2}, {Mixed, 2}, {Empty, 2}, {Mixed, 1},
    {Empty, 3}, {Mixed, 1}, {Empty, 7}, {Mixed, 1}, {Empty, 7}, {Mixed, 1},
    {Empty, 4}, {Mixed, 3}, {Empty, 1}, {Mixed, 1}, {Empty, 14}, {Mixed, 1},
    ...
    0xff000000, 0x0000003f, 0x00180000, 0x01ff0000, 0x00000004, 0x0007ff80,
    0x00000060, 0xfff80000, 0x00005800, 0x000ff000, 0x00000002, 0x000001ff,
    0xc0000000, 0x0080199f, 0x0000000c, 0xff000000, 0x000003a5, 0xffe00000,
    0x00000003, 0x7fff0000, 0x0f3f8000, 0x30000000, 0x1fff0000, 0x00000001,
    0x003fe000, 0x000007ff, 0x007ff000, 0x01bf0000, 0x3cfe0000, 0x00000010,
    0x000007fe, 0x0ffe0000, 0x0f7f8000, 0x001f0000, 0xb47e0000, 0x00000008,
    0x001b7c00, 0x00780000, 0xc7f00000, 0x00000001, 0xc0000000, 0x000003ff,
    0x000007f8};
    }

    const static UnicodeSet vowel_dependent_Set{const_cast<UnicodeSet::run_t *>(__vowel_dependent_Set_runs), 121, 0, const_cast<UnicodeSet::bitquad_t *>(__vowel_dependent_Set_quads), 109, 0};
    ...
    [1075, 1081], [108e, 108e], [1703, 1711], [171f, 171f], [1723, 1731],
    [1743, 1751], [1763, 176c], [176e, 1770], [1780, 17a2], [1901, 191e],
    [1950, 1962], [1980, 19ab], [1a00, 1a16], [1a20, 1a4c], [1a53, 1a54],
    [1b13, 1b33], [1b45, 1b4c], [1b8a, 1ba0], [1bae, 1baf], [1bbb, 1bbd],
    ...
    [10a19, 10a35], [11013, 11037], [11075, 11075], [1108d, 110af],
    [11107, 11126], [11144, 11144], [11147, 11147], [11155, 11172],
    [11191, 111b2], [11208, 11211], [11213, 1122b], [1123f, 1123f],
    [11284, 11286], [11288, 11288], [1128a, 1128d], [1128f, 1129d],
    [1129f, 112a8], [112ba, 112de], [11315, 11328], [1132a, 11330],
    [11332, 11333], [11335, 11339], [11392, 113b5], [1140e, 11434],
    [1148f, 114af], [1158e, 115ae], [1160e, 1162f], [1168a, 116aa],
    ...
    {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Empty, 2}, {Mixed, 6}, {Empty, 2},
    {Mixed, 2}, {Empty, 2}, {Mixed, 3}, {Empty, 1}, {Mixed, 2}, {Empty, 2},
    ...
    0x8003fff8, 0x0003fff8, 0x0003fff8, 0x0001dff8, 0x00000007, 0x7ffffffe,
    0xffff0000, 0x00000007, 0x00000fff, 0x007fffff, 0x00181fff, 0xfff80000,
    0x000fffff, 0x00001fe0, 0xfffffc00, 0x3800c001, 0x0000000f, 0x0000000f,
    ...
    0x07fd3fff, 0xfeef0001, 0x003fffff, 0xfff80000, 0x00ffffff, 0x00200000,
    0xffffe000, 0x0000ffff, 0xffffff80, 0x0000007f, 0xffe00090, 0x0007ffff,
    0xfffe0000, 0x0007ffff, 0xfffbff00, 0x80000fff, 0xbfffbd70, 0xfc0001ff,
    0x7fffffff, 0xffe00000, 0x03edfdff, 0xfffc0000, 0x003fffff, 0xffffc000,
    ...
    0x00000fff, 0xff6ff000, 0x0000ffff, 0xffffc000, 0x0001ffff, 0xfffff800,
    0x0007ffff, 0xf0000000, 0x0000000f, 0xffffc000, 0x00007fff, 0xfffc0000,
    0x0000ffff, 0xfffff000, 0x0001ffff, 0xfffff000, 0x000003ff, 0x0003ffff,
    0xfffc0000, 0x000fffff, 0x3ffffffe, 0xfffffff8, 0x00000007};
    }

    const static UnicodeSet consonant_Set{const_cast<UnicodeSet::run_t *>(__consonant_Set_runs), 116, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_Set_quads), 137, 0};
    ...
    const static UnicodeSet consonant_dead_Set{const_cast<UnicodeSet::run_t *>(__consonant_dead_Set_runs), 11, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_dead_Set_quads), 6, 0};
    ...
    const static UnicodeSet consonant_preceding_repha_Set{const_cast<UnicodeSet::run_t *>(__consonant_preceding_repha_Set_runs), 11, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_preceding_repha_Set_quads), 5, 0};
    ...
    const static UnicodeSet consonant_succeeding_repha_Set{const_cast<UnicodeSet::run_t *>(__consonant_succeeding_repha_Set_runs), 3, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_succeeding_repha_Set_quads), 1, 0};
    ...
    const static UnicodeSet consonant_medial_Set{const_cast<UnicodeSet::run_t *>(__consonant_medial_Set_runs), 25, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_medial_Set_quads), 15, 0};
    ...
    const static UnicodeSet consonant_final_Set{const_cast<UnicodeSet::run_t *>(__consonant_final_Set_runs), 25, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_final_Set_quads), 14, 0};
    ...
    const static UnicodeSet gemination_mark_Set{const_cast<UnicodeSet::run_t *>(__gemination_mark_Set_runs), 11, 0, const_cast<UnicodeSet::bitquad_t *>(__gemination_mark_Set_quads), 5, 0};
    ...
    const static UnicodeSet cantillation_mark_Set{const_cast<UnicodeSet::run_t *>(__cantillation_mark_Set_runs), 19, 0, const_cast<UnicodeSet::bitquad_t *>(__cantillation_mark_Set_quads), 10, 0};
    ...
    {Mixed, 1}, {Empty, 10}, {Mixed, 1}, {Empty, 9}, {Mixed, 1},
    ...
    const static UnicodeSet syllable_modifier_Set{const_cast<UnicodeSet::run_t *>(__syllable_modifier_Set_runs), 29, 0, const_cast<UnicodeSet::bitquad_t *>(__syllable_modifier_Set_quads), 15, 0};
    ...
    {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Empty, 16}, {Mixed, 1},
    ...
    0x03ff0000, 0x03ff0000, 0xffff03ff, 0x0000000f, 0x0fff0000, 0x03ff0000,
    0xffff0000, 0x00001fff, 0x03ff0000, 0x000003ff, 0x03ff0000, 0x03ff0000,
    0x03ff0000};
    }

    const static UnicodeSet number_Set{const_cast<UnicodeSet::run_t *>(__number_Set_runs), 91, 0, const_cast<UnicodeSet::bitquad_t *>(__number_Set_quads), 49, 0};
    ...
    static EnumeratedPropertyObject property_object
        ...
        std::move(INSC_ns::aliases),{
        &other_Set, &bindu_Set, &visarga_Set, &avagraha_Set, &nukta_Set,
        &virama_Set, &pure_killer_Set, &reordering_killer_Set,
        &invisible_stacker_Set, &vowel_independent_Set,
        &vowel_dependent_Set, &vowel_Set, &consonant_placeholder_Set,
        &consonant_Set, &consonant_dead_Set, &consonant_with_stacker_Set,
        &consonant_prefixed_Set, &consonant_preceding_repha_Set,
        &consonant_initial_postfixed_Set, &consonant_succeeding_repha_Set,
        &consonant_subjoined_Set, &consonant_medial_Set,
        &consonant_final_Set, &consonant_head_letter_Set,
        &modifying_letter_Set, &tone_letter_Set, &tone_mark_Set,
        &gemination_mark_Set, &cantillation_mark_Set, &register_shifter_Set,
