...
namespace UCD {
  namespace INSC_ns {
    ...
    [11a01, 11a0a], [11a51, 11a5b], [11b60, 11b67], [11c2f, 11c36],
    [11c38, 11c3b], [11cb0, 11cb4], [11d31, 11d36], [11d3a, 11d3a],
    [11d3c, 11d3d], [11d3f, 11d3f], [11d43, 11d43], [11d8a, 11d8e],
    [11d90, 11d91], [11d93, 11d94], [11ef3, 11ef6], [11f34, 11f3a],
    [11f3e, 11f40], [1611e, 16129], [16d63, 16d6a] */
    ...
    {Empty, 4}, {Mixed, 3}, {Empty, 1}, {Mixed, 1}, {Empty, 8}, {Mixed, 1},
    {Empty, 5}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 3}, {Mixed, 2},
    {Empty, 1}, {Mixed, 1}, {Empty, 10}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
    {Empty, 525}, {Mixed, 2}, {Empty, 97}, {Mixed, 1}, {Empty, 31892}};
    ...
    0x000007fe, 0x0ffe0000, 0x000000ff, 0x0f7f8000, 0x001f0000, 0xb47e0000,
    0x00000008, 0x001b7c00, 0x00780000, 0xc7f00000, 0x00000001, 0xc0000000,
    0x000003ff, 0x000007f8};
    const static UnicodeSet vowel_dependent_Set{__vowel_dependent_Set_runs, 123, __vowel_dependent_Set_quads, 110};
    ...
    [104b, 104b], [104e, 104e], [1cfa, 1cfa], [2010, 2014], [25cc, 25cc],
    ...
    {Empty, 6}, {Mixed, 1}, {Empty, 46}, {Mixed, 1}, {Empty, 100},
    {Mixed, 1}, {Empty, 24}, {Mixed, 1}, {Empty, 45}, {Mixed, 1},
    ...
    0x04000000, 0x001f0000, 0x00001000, 0x00700000, 0x80000000, 0x00000020,
    0x00040000};
    const static UnicodeSet consonant_placeholder_Set{__consonant_placeholder_Set_runs, 23, __consonant_placeholder_Set_quads, 13};
    ...
    [1743, 1751], [1763, 176c], [176e, 1770], [1780, 17a2], [1900, 191e],
    ...
    0x8003fff8, 0x0003fff8, 0x0003fff8, 0x0001dff8, 0x00000007, 0x7fffffff,
    ...
    {Mixed, 1}, {Empty, 34}, {Mixed, 1}, {Empty, 45}, {Mixed, 1},
    {Empty, 32558}};
    const static UnicodeSet::bitquad_t __consonant_with_stacker_Set_quads[] = {
    0x00060000, 0x00600000, 0x00000018, 0x00000003, 0x04000000};
    const static UnicodeSet consonant_with_stacker_Set{__consonant_with_stacker_Set_runs, 11, __consonant_with_stacker_Set_quads, 5};

    /* Code Point Ranges for Consonant_Prefixed
    [111c2, 111c3], [1193f, 1193f], [11a84, 11a85], [11a87, 11a89] */
    const static UnicodeSet::run_t __consonant_prefixed_Set_runs[] = {
    {Empty, 2190}, {Mixed, 1}, {Empty, 58}, {Mixed, 1}, {Empty, 10},
    {Mixed, 1}, {Empty, 32555}};
    const static UnicodeSet::bitquad_t __consonant_prefixed_Set_quads[] = {0x0000000c, 0x80000000, 0x000003b0};
    const static UnicodeSet consonant_prefixed_Set{__consonant_prefixed_Set_runs, 7, __consonant_prefixed_Set_quads, 3};

    /* Code Point Ranges for Consonant_Preceding_Repha
    [0d4e, 0d4e], [113d1, 113d1], [11941, 11941], [11a86, 11a86],
    ...
    0x00004000, 0x00020000, 0x00000002, 0x00000040, 0x00000040, 0x00000004};
    const static UnicodeSet consonant_preceding_repha_Set{__consonant_preceding_repha_Set_runs, 13, __consonant_preceding_repha_Set_quads, 6};
