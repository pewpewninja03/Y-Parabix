...
namespace UCD {
  namespace GCB_ns {
    ...
    [1a61, 1a61], [1a63, 1a64], [1a7d, 1a7e], [1a80, 1aaf], [1acf, 1aff],
    [1b05, 1b33], [1b45, 1b6a], [1b74, 1b7f], [1b83, 1ba0], [1bae, 1be5],
    [1bf4, 1c23], [1c38, 1ccf], [1cd3, 1cd3], [1ce9, 1cec], [1cee, 1cf3],
    [1cf5, 1cf6], [1cfa, 1dbf], [1e00, 200a], [2010, 2027], [202f, 205f],
    [2070, 20cf], [20f1, 2cee], [2cf2, 2d7e], [2d80, 2ddf], [2e00, 3029],
    [3030, 3098], [309b, a66e], [a673, a673], [a67e, a69d], [a6a0, a6ef],
    [a6f2, a801], [a803, a805], [a807, a80a], [a80c, a822], [a828, a82b],
    [a82d, a87f], [a882, a8b3], [a8c6, a8df], [a8f2, a8fe], [a900, a925],
    [a92e, a946], [a954, a95f], [a97d, a97f], [a984, a9b2], [a9c1, a9e4],
    [a9e6, aa28], [aa37, aa42], [aa44, aa4b], [aa4e, aa7b], [aa7d, aaaf],
    [aab1, aab1], [aab5, aab6], [aab9, aabd], [aac0, aac0], [aac2, aaea],
    [aaf0, aaf4], [aaf7, abe2], [abeb, abeb], [abee, abff], [d7a4, d7af],
    [d7c7, d7ca], [d7fc, fb1d], [fb1f, fdff], [fe10, fe1f], [fe30, fefe],
    [ff00, ff9d], [ffa0, ffef], [fffc, 101fc], [101fe, 102df],
    ...
    [11a0b, 11a32], [11a3f, 11a46], [11a48, 11a50], [11a5c, 11a83],
    [11a9a, 11c2e], [11c37, 11c37], [11c40, 11c91], [11ca8, 11ca8],
    [11cb7, 11d30], [11d37, 11d39], [11d3b, 11d3b], [11d3e, 11d3e],
    [11d48, 11d89], [11d8f, 11d8f], [11d92, 11d92], [11d98, 11ef2],
    [11ef7, 11eff], [11f04, 11f33], [11f3b, 11f3d], [11f43, 11f59],
    [11f5b, 1342f], [13441, 13446], [13456, 1611d], [16130, 16aef],
    [16af5, 16b2f], [16b37, 16d62], [16d64, 16d66], [16d6b, 16f4e],
    [16f50, 16f50], [16f88, 16f8e], [16f93, 16fe3], [16fe5, 16fef],
    [16ff2, 1bc9c], [1bc9f, 1bc9f], [1bca4, 1ceff], [1cf2e, 1cf2f],
    ...
    {Full, 1}, {Mixed, 1}, {Full, 4}, {Mixed, 2}, {Full, 6}, {Empty, 2},
    {Full, 16}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 2}, {Mixed, 2},
    {Full, 95}, {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 3}, {Empty, 1},
    {Full, 17}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 942}, {Mixed, 2},
    {Full, 2}, {Mixed, 1}, {Full, 8}, {Mixed, 2}, {Full, 2}, {Mixed, 4},
    {Full, 1}, {Mixed, 7}, {Full, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 3},
    {Full, 7}, {Mixed, 1}, {Empty, 349}, {Mixed, 3}, {Full, 280},
    {Mixed, 1}, {Full, 23}, {Mixed, 2}, {Full, 5}, {Mixed, 1}, {Full, 4},
    {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 15}, {Mixed, 1}, {Full, 7},
    {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 52}, {Mixed, 2}, {Full, 5},
    {Mixed, 1}, {Full, 17}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 9},
    {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Full, 3}, {Mixed, 7}, {Full, 1}, {Mixed, 7}, {Full, 2},
    ...
    0xf000f000, 0xf07fffff, 0x801fffff, 0x6000001a, 0x0000ffff, 0xffff8000,
    0xffffffe0, 0x000fffff, 0xffffffe0, 0xfff007ff, 0xfffffff8, 0xffffc001,
    0xfff0003f, 0xff00000f, 0x0008ffff, 0xfc6fde00, 0xffff07ff, 0xffff80ff,
    ...
    0x0fffffff, 0xfffe003f, 0xffffffc3, 0xfffffff8, 0x00ffffff, 0xffffff80,
    0x7fe6ffff, 0xfffffff8, 0xd800ffff, 0xffffdffb, 0xfffffff8, 0xffe0007f,
    0xffffff9f, 0xfff7ffff, 0xfffffff8, 0x0007ffff, 0xffff21f2, 0xbf000fff,
    0xfffffffd, 0x7fffffff, 0xfffff800, 0xfffffff0, 0x27ffffff, 0xff7fc660,
    0xffe0e033, 0x00ffffff, 0xfff8085a, 0xfffffff9, 0x001fffff, 0xbfffff80,
    0x0000ffff, 0xfffffff0, 0x00c07fff, 0xcffffffe, 0x0000ffff, 0xfffffffe,
    0xff0007ff, 0x1fffffff, 0xfffff003, 0xf8000fff, 0x0640ffff, 0xfffffff0,
    0x0301ffff, 0xffffffee, 0xfffff801, 0x8007ffff, 0xf001ff7f, 0xfc00000f,
    0x00807fff, 0x0003ffff, 0xff800100, 0x4b81ffff, 0xffffff00, 0xff0483ff,
    0xff87ffff, 0xfffffff0, 0x380fffff, 0xfbfffff8, 0x0000ffff, 0xffc0007e,
    0x3fffffff, 0xffff0000, 0xffe0ffff, 0xff80ffff, 0xfffff877, 0x00017fff,
    0xfff87f00, 0xfffcffef, 0x9fffffff, 0xfffffff0, 0x0000c000, 0xffffff80,
    0x00001c1f, 0xfffff018, 0xffffc3ff, 0xffffffe3, 0x07800000, 0xffdfe000,
    ...
    [1cf8, 1cf9], [1dc0, 1dff], [200c, 200c], [20d0, 20f0], [2cef, 2cf1],
    ...
    0xfff70000, 0x031021fd, 0x00001000, 0xffff0000, 0x0001ffff, 0x00038000,
