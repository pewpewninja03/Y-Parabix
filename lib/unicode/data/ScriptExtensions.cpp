...
const static UnicodeSet::run_t __zzzz_Ext_runs[] = {
        ...
        {Empty, 10}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 6},
        {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
        {Empty, 2}, {Mixed, 1}, {Empty, 3}, {Mixed, 2}, {Empty, 2},
        ...
        {Mixed, 1}, {Full, 1}, {Mixed, 3}, {Empty, 19}, {Mixed, 3},
        ...
        {Mixed, 4}, {Full, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 1},
...
const static UnicodeSet::run_t __zyyy_Ext_runs[] = {
        ...
        [0310, 0311], [0313, 0313], [0323, 0325], [032d, 032e],
        [0330, 0331], [0358, 0358], [035e, 035e], [0363, 036f],
...
const static UnicodeSet::run_t __arab_Ext_runs[] = {
        ...
        {Mixed, 1}, {Empty, 1639}, {Mixed, 1}, {Full, 19}, {Mixed, 2},
        {Empty, 3}, {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Empty, 31},
        {Mixed, 1}, {Empty, 91}, {Mixed, 1}, {Empty, 2}, {Mixed, 2},
        ...
        [0303, 0304], [0307, 0308], [030a, 030a], [0323, 0325],
        [032d, 032e], [0330, 0331], [060c, 060c], [061b, 061c],
        [061f, 061f], [0640, 0640], [064b, 0655], [0670, 0670],
...
const static UnicodeSet::run_t __syrc_Ext_runs[] = {
        ...
        0x00000598, 0x00036038, 0x98001000, 0x003ff801, 0x00010000,
...
const static UnicodeSet::run_t __hani_Ext_runs[] = {
        ...
        {Empty, 109}, {Full, 1335}, {Empty, 1}, {Full, 136}, {Mixed, 1},
        {Full, 180}, {Mixed, 1}, {Full, 233}, {Mixed, 1}, {Full, 18},
        {Mixed, 1}, {Empty, 77}, {Full, 16}, {Mixed, 1}, {Empty, 47},
        {Full, 154}, {Mixed, 1}, {Full, 264}, {Mixed, 1}, {Empty, 28252}};
...
const static UnicodeSet::run_t __glag_Ext_runs[] = {
        ...
        [0302, 0302], [0304, 0304], [0306, 0309], [0323, 0323],
        [2d30, 2d67], [2d6f, 2d70], [2d7f, 2d7f]*/
const static UnicodeSet::run_t __tfng_Ext_runs[] = {
        {Empty, 24}, {Mixed, 2}, {Empty, 335}, {Mixed, 1}, {Full, 1},
        {Mixed, 1}, {Empty, 34452}};
        const static UnicodeSet::bitquad_t __tfng_Ext_quads[] = {
        0x000003d4, 0x00000008, 0xffff0000, 0x800180ff};
        const static UnicodeSet tfng_Ext{__tfng_Ext_runs, 7, __tfng_Ext_quads, 4};
...
const static UnicodeSet::run_t __plrd_Ext_runs[] = {
        ...
        [1ce0, 1ce0], [1cea, 1cea], [1ced, 1ced], [a830, a835],
        [a838, a838], [11180, 111df], [11b60, 11b67]*/
const static UnicodeSet::run_t __shrd_Ext_runs[] = {
        {Empty, 74}, {Mixed, 1}, {Empty, 155}, {Mixed, 2}, {Empty, 1113},
        {Mixed, 1}, {Empty, 842}, {Full, 3}, {Empty, 76}, {Mixed, 1},
        {Empty, 32548}};
        const static UnicodeSet::bitquad_t __shrd_Ext_quads[] = {
        0x00020000, 0x32800000, 0x00002401, 0x013f0000, 0x000000ff};
        const static UnicodeSet shrd_Ext{__shrd_Ext_runs, 11, __shrd_Ext_quads, 5};
...
const static UnicodeSet::run_t __sind_Ext_runs[] = {
        ...
        [0951, 0952], [0964, 0965], [1cd5, 1cd5], [1ce2, 1ce2],
        [1cf2, 1cf2], [a830, a839], [11480, 114c7], [114d0, 114d9]*/
const static UnicodeSet::run_t __tirh_Ext_runs[] = {
        {Empty, 74}, {Mixed, 2}, {Empty, 154}, {Mixed, 2}, {Empty, 1113},
        {Mixed, 1}, {Empty, 866}, {Full, 2}, {Mixed, 1}, {Empty, 32601}};
        const static UnicodeSet::bitquad_t __tirh_Ext_quads[] = {
        0x00060000, 0x00000030, 0x00200000, 0x00040004, 0x03ff0000,
        0x03ff00ff};
        const static UnicodeSet tirh_Ext{__tirh_Ext_runs, 10, __tirh_Ext_quads, 6};
...
const static UnicodeSet::run_t __marc_Ext_runs[] = {{Empty, 2275}, {Mixed, 3}, {Empty, 32538}};
        ...
        [0951, 0952], [1cd5, 1cd5], [1cd7, 1cd8], [1ce2, 1ce2],
        [1ce9, 1ce9], [1ceb, 1ceb], [1ced, 1ced], [11400, 1145b],
        [1145d, 11461]*/
const static UnicodeSet::run_t __newa_Ext_runs[] = {
        {Empty, 74}, {Mixed, 1}, {Empty, 155}, {Mixed, 2}, {Empty, 1976},
        {Full, 2}, {Mixed, 2}, {Empty, 32604}};
        const static UnicodeSet::bitquad_t __newa_Ext_quads[] = {
        0x00060000, 0x01a00000, 0x00002a04, 0xefffffff, 0x00000003};
        const static UnicodeSet newa_Ext{__newa_Ext_runs, 8, __newa_Ext_quads, 5};
...
const static UnicodeSet::run_t __elym_Ext_runs[] = {{Empty, 2175}, {Mixed, 1}, {Empty, 32640}};
        ...
        [0951, 0951], [0964, 0965], [0ce6, 0cef], [1ce9, 1ce9],
        [1cf2, 1cf2], [1cfa, 1cfa], [a830, a835], [119a0, 119a7],
        [119aa, 119d7], [119da, 119e4]*/
const static UnicodeSet::run_t __nand_Ext_runs[] = {
        {Empty, 74}, {Mixed, 2}, {Empty, 27}, {Mixed, 1}, {Empty, 127},
        {Mixed, 1}, {Empty, 1113}, {Mixed, 1}, {Empty, 907}, {Mixed, 3},
        {Empty, 32560}};
        const static UnicodeSet::bitquad_t __nand_Ext_quads[] = {
        0x00020000, 0x00000030, 0x0000ffc0, 0x04040200, 0x003f0000,
        0xfffffcff, 0xfcffffff, 0x0000001f};
        const static UnicodeSet nand_Ext{__nand_Ext_runs, 11, __nand_Ext_quads, 8};
...
const static UnicodeSet::run_t __tutg_Ext_runs[] = {
        ...
        /* Code Point Ranges for Sidt
        [10940, 10959]*/
const static UnicodeSet::run_t __sidt_Ext_runs[] = {{Empty, 2122}, {Mixed, 1}, {Empty, 32693}};
        const static UnicodeSet::bitquad_t __sidt_Ext_quads[] = {0x03ffffff};
        const static UnicodeSet sidt_Ext{__sidt_Ext_runs, 3, __sidt_Ext_quads, 1};
        /* Code Point Ranges for Tayo
        [1e6c0, 1e6de], [1e6e0, 1e6f5], [1e6fe, 1e6ff]*/
const static UnicodeSet::run_t __tayo_Ext_runs[] = {{Empty, 3894}, {Mixed, 2}, {Empty, 30920}};
        const static UnicodeSet::bitquad_t __tayo_Ext_quads[] = {0x7fffffff, 0xc03fffff};
        const static UnicodeSet tayo_Ext{__tayo_Ext_runs, 3, __tayo_Ext_quads, 2};
        /* Code Point Ranges for Tols
        [11db0, 11ddb], [11de0, 11de9]*/
const static UnicodeSet::run_t __tols_Ext_runs[] = {{Empty, 2285}, {Mixed, 3}, {Empty, 32528}};
        const static UnicodeSet::bitquad_t __tols_Ext_quads[] = {0xffff0000, 0x0fffffff, 0x000003ff};
        const static UnicodeSet tols_Ext{__tols_Ext_runs, 3, __tols_Ext_quads, 3};
        /* Code Point Ranges for Berf
        [16ea0, 16eb8], [16ebb, 16ed3]*/
