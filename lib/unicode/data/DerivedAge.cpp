...
namespace UCD {
  namespace AGE_ns {
    const unsigned independent_prop_values = 28;
    ...
    [fdc8, fdce], [fe1a, fe1f], [fe53, fe53], [fe67, fe67], [fe6c, fe6f],
    ...
    [1f6d8, 1f6db], [1f6ed, 1f6ef], [1f6fd, 1f6ff], [1f777, 1f77a],
    [1f7da, 1f7df], [1f7ec, 1f7ef], [1f7f1, 1f7ff], [1f80c, 1f80f],
    [1f848, 1f84f], [1f85a, 1f85f], [1f888, 1f88f], [1f8ae, 1f8af],
    [1f8bc, 1f8bf], [1f8c2, 1f8ff], [1fa54, 1fa5f], [1fa6e, 1fa6f],
    [1fa7d, 1fa7f], [1fa8a, 1fa8e], [1fac7, 1facd], [1fadd, 1fade],
    [1faea, 1faef], [1faf9, 1faff], [1fb93, 1fb93], [1fbfa, 1fffd],
    [2a6e0, 2a6ff], [2b73a, 2b73f], [2b81e, 2b81f], [2cea2, 2ceaf],
    [2ebe1, 2ebef], [2ee5e, 2f7ff], [2fa1e, 2fffd], [3134b, 3134f],
    [323b0, 3fffd], [40000, 4fffd], [50000, 5fffd], [60000, 6fffd],
    [70000, 7fffd], [80000, 8fffd], [90000, 9fffd], [a0000, afffd],
    [b0000, bfffd], [c0000, cfffd], [d0000, dfffd], [e0000, e0000],
    [e0002, e001f], [e0080, e00ff], [e01f0, efffd] */
    ...
    {Mixed, 3}, {Empty, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 3}, {Full, 2},
    ...
    {Empty, 1}, {Mixed, 2}, {Full, 5}, {Empty, 1}, {Mixed, 7}, {Full, 2},
    {Mixed, 6}, {Full, 9}, {Mixed, 4}, {Full, 2}, {Mixed, 1}, {Empty, 1},
    ...
    {Full, 13}, {Empty, 1}, {Mixed, 1}, {Full, 6}, {Empty, 2}, {Mixed, 1},
    {Full, 3}, {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 2},
    {Mixed, 1}, {Empty, 191}, {Mixed, 1}, {Empty, 38}, {Mixed, 3},
    {Full, 278}, {Mixed, 1}, {Empty, 9}, {Mixed, 3}, {Empty, 11},
    {Mixed, 1}, {Full, 72}, {Empty, 3}, {Mixed, 3}, {Full, 122}, {Empty, 7},
    {Mixed, 1}, {Empty, 13}, {Mixed, 1}, {Full, 2}, {Empty, 1}, {Mixed, 2},
    {Empty, 3}, {Mixed, 1}, {Full, 1}, {Empty, 7}, {Mixed, 1}, {Empty, 1},
    {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Full, 3},
    {Mixed, 2}, {Empty, 2}, {Mixed, 2}, {Full, 4}, {Empty, 2}, {Mixed, 1},
    {Empty, 1}, {Mixed, 3}, {Empty, 1}, {Mixed, 3}, {Empty, 10}, {Mixed, 1},
    {Empty, 8}, {Mixed, 1}, {Empty, 21}, {Mixed, 2}, {Full, 34}, {Mixed, 2},
    {Full, 6}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Full, 3}, {Empty, 1},
    {Mixed, 2}, {Full, 9}, {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Full, 14},
    {Mixed, 2}, {Full, 6}, {Mixed, 2}, {Full, 15}, {Mixed, 1}, {Empty, 6},
    ...
    {Mixed, 4}, {Empty, 5}, {Mixed, 1}, {Full, 1}, {Mixed, 5}, {Full, 4},
    {Empty, 30}, {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 3},
    {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Full, 1}, {Empty, 10},
    {Mixed, 3}, {Empty, 1}, {Mixed, 2}, {Empty, 4}, {Mixed, 1}, {Empty, 2},
    {Mixed, 1}, {Full, 31}, {Mixed, 1}, {Empty, 1335}, {Full, 1},
    ...
    {Empty, 154}, {Mixed, 1}, {Empty, 130}, {Mixed, 1}, {Full, 1761},
    ...
    0x00007f00, 0xfc000000, 0x00080000, 0x0020f080, 0x60000000, 0x00000001,
    0x80000000, 0xe3030303, 0x01ff8080, 0x00001000, 0x48000080, 0xc000c000,
    ...
    0x80000000, 0xfffcc400, 0xffffffe3, 0x0fffffff, 0x0000ff00, 0xfc000000,
    ...
    0x0000fff8, 0xfe000000, 0xfffffc00, 0xfc00fffc, 0x00000200, 0x00800000,
    0x0000ffc0, 0x0000e000, 0x00030000, 0xff800100, 0x00000480, 0x4b800000,
    0xfc00ff00, 0x00000240, 0xfe048000, 0xfffffc00, 0xfe000000, 0x00020000,
    ...
    0x00007800, 0x00007f00, 0xfffcffe0, 0xff000000, 0xffc00000, 0x7fffffff,
    0xfffffe00, 0x9010ffff, 0xfffbfff8, 0xffd8ffff, 0x0000ff0f, 0xf0000000,
    0xe000f800, 0x0c00fe00, 0xfffffff0, 0xfc000000, 0xfff00000, 0x0000c000,
    0x0000ff80, 0xfffffff0, 0xffc00000, 0x00000180, 0xfffff800, 0xffffffc0,
    0xfff00000, 0xfff00000, 0xff800000, 0xfe000000, 0x00200000, 0x20000000,
    0x1400219b, 0x00000010, 0x20201840, 0x84000000, 0x000203a0, 0x000000c0,
    0x00003000, 0x07fff000, 0xffff0001, 0x80000000, 0xfffff81f, 0x06000080,
    0x0000f824, 0xffffc000, 0xffff7fff, 0xc000e000, 0xffff3c00, 0x0000ffff,
    0xffff8000, 0x7c000000, 0x0000ffff, 0xfc000000, 0x0000ffff, 0x78000000,
    ...
    0xffffffc0, 0x0f000000, 0xe000e000, 0x07800000, 0xfc000000, 0xfffef000,
    0x0000f000, 0xfc00ff00, 0x0000ff00, 0xf000c000, 0xfffffffc, 0xfff00000,
    0xe000c000, 0x00007c00, 0x60003f80, 0xfe00fc00, 0x00080000, 0xfc000000,
    0x3fffffff, 0xfc000000, 0xc0000000, 0x0000fffc, 0x0000fffe, 0xc0000000,
    0xc0000000, 0x3fffffff, 0x0000f800, 0xffff0000, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0xfffffffd, 0xffff0000, 0x3fffffff};
    const static UnicodeSet unassigned_Set{__unassigned_Set_runs, 471, __unassigned_Set_quads, 450};
