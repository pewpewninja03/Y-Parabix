...
namespace UCD {
  namespace EA_ns {
    ...
    [261d, 261d], [261f, 262f], [2638, 263f], [2641, 2641], [2643, 2647],
    [2654, 265f], [2662, 2662], [2666, 2666], [266b, 266b], [266e, 266e],
    [2670, 267e], [2680, 2689], [2690, 2692], [2694, 269d], [26a0, 26a0],
    [26a2, 26a9], [26ac, 26bc], [26c0, 26c3], [26e2, 26e2], [26e4, 26e7],
    [2700, 2704], [2706, 2709], [270c, 2727], [2729, 273c], [273e, 274b],
    [274d, 274d], [274f, 2752], [2756, 2756], [2758, 2775], [2780, 2794],
    [2798, 27af], [27b1, 27be], [27c0, 27e5], [27ee, 2984], [2987, 2b1a],
    [2b1d, 2b4f], [2b51, 2b54], [2b5a, 2e7f], [2e9a, 2e9a], [2ef4, 2eff],
    [2fd6, 2fef], [303f, 3040], [3097, 3098], [3100, 3104], [3130, 3130],
    [318f, 318f], [31e6, 31ee], [321f, 321f], [a48d, a48f], [a4c7, a95f],
    ...
    [16fe5, 16fef], [16ff7, 16fff], [18cd6, 18cfe], [18d1f, 18d7f],
    [18df3, 1afef], [1aff4, 1aff4], [1affc, 1affc], [1afff, 1afff],
    [1b123, 1b131], [1b133, 1b14f], [1b153, 1b154], [1b156, 1b163],
    [1b168, 1b16f], [1b2fc, 1d2ff], [1d357, 1d35f], [1d377, 1f003],
    [1f005, 1f0ce], [1f0d0, 1f0ff], [1f10b, 1f10f], [1f12e, 1f12f],
    [1f16a, 1f16f], [1f1ad, 1f1ff], [1f203, 1f20f], [1f23c, 1f23f],
    [1f249, 1f24f], [1f252, 1f25f], [1f266, 1f2ff], [1f321, 1f32c],
    [1f336, 1f336], [1f37d, 1f37d], [1f394, 1f39f], [1f3cb, 1f3ce],
    [1f3d4, 1f3df], [1f3f1, 1f3f3], [1f3f5, 1f3f7], [1f43f, 1f43f],
    [1f441, 1f441], [1f4fd, 1f4fe], [1f53e, 1f54a], [1f54f, 1f54f],
    [1f568, 1f579], [1f57b, 1f594], [1f597, 1f5a3], [1f5a5, 1f5fa],
    [1f650, 1f67f], [1f6c6, 1f6cb], [1f6cd, 1f6cf], [1f6d3, 1f6d4],
    [1f6d9, 1f6db], [1f6e0, 1f6ea], [1f6ed, 1f6f3], [1f6fd, 1f7df],
    [1f7ec, 1f7ef], [1f7f1, 1f90b], [1f93b, 1f93b], [1f946, 1f946],
    [1fa00, 1fa6f], [1fa7d, 1fa7f], [1fa8b, 1fa8d], [1fac7, 1fac7],
    [1fac9, 1facc], [1fadd, 1fade], [1faeb, 1faee], [1faf9, 1ffff],
    [2fffe, 2ffff], [3fffe, e00ff], [e01f0, effff], [ffffe, fffff],
    [10fffe, 10ffff] */
    ...
    {Full, 3}, {Empty, 4}, {Mixed, 1}, {Empty, 2}, {Mixed, 20}, {Full, 1},
    {Mixed, 1}, {Full, 12}, {Mixed, 1}, {Full, 11}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Full, 25}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 6},
    {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Empty, 3},
    {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Empty, 2}, {Mixed, 2},
    {Empty, 915}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 36},
    {Mixed, 1}, {Full, 20}, {Empty, 349}, {Mixed, 1}, {Full, 66},
    {Empty, 216}, {Full, 24}, {Mixed, 4}, {Full, 4}, {Mixed, 1}, {Empty, 4},
    {Mixed, 3}, {Full, 895}, {Mixed, 1}, {Empty, 230}, {Mixed, 3},
    {Full, 3}, {Empty, 3}, {Mixed, 1}, {Full, 271}, {Mixed, 1}, {Empty, 9},
    {Mixed, 3}, {Empty, 11}, {Mixed, 1}, {Full, 256}, {Empty, 2},
    {Mixed, 2}, {Full, 228}, {Mixed, 1}, {Full, 5}, {Mixed, 1}, {Full, 1},
    {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 2},
    {Mixed, 4}, {Full, 4}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
    {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 4}, {Mixed, 1},
    {Empty, 1}, {Mixed, 5}, {Full, 1}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
    {Full, 1}, {Empty, 2}, {Mixed, 2}, {Full, 7}, {Mixed, 1}, {Full, 8},
    {Mixed, 3}, {Empty, 5}, {Full, 3}, {Mixed, 2}, {Empty, 1}, {Mixed, 2},
    {Full, 40}, {Empty, 2047}, {Mixed, 1}, {Empty, 2047}, {Mixed, 1},
    ...
    0xff00ffff, 0xfff000fa, 0x7fff4844, 0x3ff703ff, 0x1ffff3fd, 0x0000000f,
    0x000000f4, 0xfffff3df, 0xdffffeff, 0xff47afff, 0x003fffff, 0xff1fffff,
    0x7ffeffff, 0xffffc03f, 0xffffff9f, 0xe7ffffff, 0xfc1effff, 0x04000000,
    0xfff00000, 0xffc00000, 0x0000ffff, 0x80000000, 0x00000001, 0x01800000,
    0x0000001f, 0x00010000, 0x00008000, 0x00007fc0, 0x80000000, 0x0000e000,
    0xffffff80, 0xe0000000, 0xfffffff0, 0xfc000000, 0x0000ffff, 0x00080000,
    0xfffff080, 0x00000001, 0x80000000, 0xe3030303, 0xdfff8080, 0xff80ffe0,
    0xffc00000, 0x7fffffff, 0x80000000, 0xfff80000, 0x9010ffff, 0xfffbfff8,
    0xffd8ffff, 0x0000ff0f, 0xf0000000, 0xff800000, 0xff800000, 0xffffffef,
    0xffff7fff, 0x0000f800, 0x0000c000, 0x0000fc00, 0xffffe000, 0x0000fff8,
    0xf0000000, 0xfffcfe00, 0xffffffc0, 0x00401ffe, 0x20000000, 0xfff00000,
    0xfff07800, 0x00ee0000, 0x80000000, 0x00000002, 0x60000000, 0xc0000000,
    0x000087ff, 0xfbffff00, 0xff9fffff, 0xffffffef, 0x07ffffff, 0xffff0000,
    0x0e18efc0, 0xe00fe7ff, 0xfffef000, 0x00000fff, 0x08000000, 0x00000040,
    0xe000ffff, 0x00003800, 0x60001e80, 0xfe007800, 0xc0000000, 0xc0000000,
    0xffff0000, 0xc0000000, 0xc0000000};
    const static UnicodeSet n_Set{__n_Set_runs, 146, __n_Set_quads, 141};
    ...
    const static UnicodeSet na_Set{__na_Set_runs, 10, __na_Set_quads, 4};
    ...
    const static UnicodeSet a_Set{__a_Set_runs, 56, __a_Set_quads, 65};

    /* Code Point Ranges for W
    [1100, 115f], [231a, 231b], [2329, 232a], [23e9, 23ec], [23f0, 23f0],
    [23f3, 23f3], [25fd, 25fe], [2614, 2615], [2630, 2637], [2648, 2653],
    [267f, 267f], [268a, 268f], [2693, 2693], [26a1, 26a1], [26aa, 26ab],
    [26bd, 26be], [26c4, 26c5], [26ce, 26ce], [26d4, 26d4], [26ea, 26ea],
    [26f2, 26f3], [26f5, 26f5], [26fa, 26fa], [26fd, 26fd], [2705, 2705],
    [270a, 270b], [2728, 2728], [274c, 274c], [274e, 274e], [2753, 2755],
    [2757, 2757], [2795, 2797], [27b0, 27b0], [27bf, 27bf], [2b1b, 2b1c],
    [2b50, 2b50], [2b55, 2b55], [2e80, 2e99], [2e9b, 2ef3], [2f00, 2fd5],
    [2ff0, 2fff], [3001, 303e], [3041, 3096], [3099, 30ff], [3105, 312f],
    [3131, 318e], [3190, 31e5], [31ef, 321e], [3220, 3247], [3250, a48c],
    [a490, a4c6], [a960, a97c], [ac00, d7a3], [f900, faff], [fe10, fe19],
    [fe30, fe52], [fe54, fe66], [fe68, fe6b], [16fe0, 16fe4],
    ...
    [1b170, 1b2fb], [1d300, 1d356], [1d360, 1d376], [1f004, 1f004],
    ...
    {Mixed, 1}, {Empty, 15}, {Mixed, 12}, {Empty, 1}, {Mixed, 2},
    {Empty, 26}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 25},
    {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 6}, {Mixed, 5}, {Full, 1},
    {Mixed, 1}, {Full, 3}, {Mixed, 2}, {Full, 2}, {Mixed, 1}, {Full, 2},
    {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 913}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Empty, 36}, {Mixed, 1}, {Empty, 20}, {Full, 349},
    {Mixed, 1}, {Empty, 266}, {Full, 16}, {Empty, 24}, {Mixed, 4},
    {Empty, 907}, {Mixed, 1}, {Full, 230}, {Mixed, 3}, {Empty, 3},
    {Full, 3}, {Mixed, 1}, {Empty, 271}, {Mixed, 1}, {Full, 9}, {Mixed, 3},
    {Full, 11}, {Mixed, 1}, {Empty, 256}, {Full, 2}, {Mixed, 2},
    {Empty, 228}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 5},
    {Mixed, 1}, {Empty, 3}, {Mixed, 4}, {Empty, 4}, {Full, 1}, {Mixed, 1},
    {Full, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 2},
    {Full, 4}, {Mixed, 1}, {Full, 1}, {Mixed, 5}, {Empty, 1}, {Mixed, 1},
    {Full, 2}, {Mixed, 1}, {Empty, 1}, {Full, 2}, {Mixed, 2}, {Empty, 7},
    {Mixed, 1}, {Empty, 8}, {Mixed, 3}, {Full, 5}, {Empty, 3}, {Mixed, 2},
    {Full, 1}, {Mixed, 2}, {Empty, 40}, {Full, 2047}, {Mixed, 1},
    {Full, 2047}, {Mixed, 1}, {Empty, 26624}};
    const static UnicodeSet::bitquad_t __w_Set_quads[] = {
    0x0c000000, 0x00000600, 0x00091e00, 0x60000000, 0x00300000, 0x00ff0000,
    0x000fff00, 0x80000000, 0x0008fc00, 0x60000c02, 0x00104030, 0x242c0400,
    0x00000c20, 0x00000100, 0x00b85000, 0x00e00000, 0x80010000, 0x18000000,
    0x00210000, 0xfbffffff, 0x000fffff, 0x003fffff, 0xffff0000, 0xfffffffe,
    0x7fffffff, 0xfffffffe, 0xfe7fffff, 0xffffffe0, 0xfffeffff, 0xffff7fff,
    0xffff803f, 0x7fffffff, 0xffff00ff, 0xffff1fff, 0x0000007f, 0x1fffffff,
    0x0000000f, 0x03ff0000, 0xffff0000, 0xfff7ffff, 0x00000f7f, 0x007f001f,
    0x003fffff, 0x80000000, 0x7fffffff, 0x0007ffff, 0x6fef0000, 0x00040007,
    0x00270000, 0xffff00f0, 0x0fffffff, 0x007fffff, 0x007fffff, 0x00000010,
    0x00008000, 0x07fe4000, 0xffff0007, 0x0fffffff, 0x000301ff, 0x0000003f,
    0xffbfe001, 0xdfffffff, 0x000fffff, 0x000f87ff, 0xff11ffff, 0x7fffffff,
    0xfffffffd, 0x9fffffff, 0x3fffffff, 0xffff7800, 0x040000ff, 0x00600000,
    0x00000010, 0xf8000000, 0x0000ffff, 0xf1e7103f, 0x1ff01800, 0x00010fff,
    0xfffff000, 0xf7ffffff, 0xffffffbf, 0x1fff0000, 0xffffc7ff, 0x9fffe17f,
    0x01ff87ff, 0x3fffffff, 0x3fffffff};
    const static UnicodeSet w_Set{__w_Set_runs, 102, __w_Set_quads, 87};
    ...
    const static UnicodeSet h_Set{__h_Set_runs, 7, __h_Set_quads, 5};

    /* Code Point Ranges for F    [3000, 3000], [ff01, ff60], [ffe0, ffe6] */
