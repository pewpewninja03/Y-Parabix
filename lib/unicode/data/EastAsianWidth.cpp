...
namespace UCD {
  namespace EA_ns {
    ...
    [16fe5, 16fef], [16ff2, 16fff], [187f8, 187ff], [18cd6, 18cfe],
    [18d09, 1afef], [1aff4, 1aff4], [1affc, 1affc], [1afff, 1afff],
    ...
    [1f6d8, 1f6db], [1f6e0, 1f6ea], [1f6ed, 1f6f3], [1f6fd, 1f7df],
    [1f7ec, 1f7ef], [1f7f1, 1f90b], [1f93b, 1f93b], [1f946, 1f946],
    [1fa00, 1fa6f], [1fa7d, 1fa7f], [1fa8a, 1fa8e], [1fac7, 1facd],
    [1fadd, 1fade], [1faea, 1faef], [1faf9, 1ffff], [2fffe, 2ffff],
    [3fffe, e00ff], [e01f0, effff], [ffffe, fffff], [10fffe, 10ffff] */
    ...
    0xfffff080, 0x00000001, 0x80000000, 0xe3030303, 0xdfff8080, 0xfffcffe0,
    0xff000000, 0xffc00000, 0x7fffffff, 0xfffffe00, 0x9010ffff, 0xfffbfff8,
    ...
    0x0f18efc0, 0xe00fe7ff, 0xfffef000, 0x00000fff, 0x08000000, 0x00000040,
    0xe000ffff, 0x00007c00, 0x60003f80, 0xfe00fc00, 0xc0000000, 0xc0000000,
    0xffff0000, 0xc0000000, 0xc0000000};
    const static UnicodeSet n_Set{__n_Set_runs, 145, __n_Set_quads, 141};
    ...
    {Empty, 907}, {Mixed, 1}, {Full, 191}, {Mixed, 1}, {Full, 38},
    {Mixed, 3}, {Empty, 278}, {Mixed, 1}, {Full, 9}, {Mixed, 3}, {Full, 11},
    {Mixed, 1}, {Empty, 256}, {Full, 2}, {Mixed, 2}, {Empty, 228},
    {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 3},
    {Mixed, 4}, {Empty, 4}, {Full, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 2},
    {Full, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 2}, {Full, 4}, {Mixed, 1},
    {Full, 1}, {Mixed, 5}, {Empty, 1}, {Mixed, 1}, {Full, 2}, {Mixed, 1},
    {Empty, 1}, {Full, 2}, {Mixed, 2}, {Empty, 7}, {Mixed, 1}, {Empty, 8},
    {Mixed, 3}, {Full, 5}, {Empty, 3}, {Mixed, 2}, {Full, 1}, {Mixed, 2},
    {Empty, 40}, {Full, 2047}, {Mixed, 1}, {Full, 2047}, {Mixed, 1},
    {Empty, 26624}};
    ...
    0x0000000f, 0x03ff0000, 0xffff0000, 0xfff7ffff, 0x00000f7f, 0x0003001f,
    0x00ffffff, 0x003fffff, 0x80000000, 0x000001ff, 0x6fef0000, 0x00040007,
    ...
    0x00000010, 0xf8000000, 0x0000ffff, 0xf0e7103f, 0x1ff01800, 0x00010fff,
    0xfffff000, 0xf7ffffff, 0xffffffbf, 0x1fff0000, 0xffff83ff, 0x9fffc07f,
    0x01ff03ff, 0x3fffffff, 0x3fffffff};
    const static UnicodeSet w_Set{__w_Set_runs, 101, __w_Set_quads, 87};
