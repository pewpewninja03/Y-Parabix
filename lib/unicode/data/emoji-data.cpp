...
namespace UCD {
    namespace EMOJI_ns {
        ...
        [1f6cb, 1f6d2], [1f6d5, 1f6d7], [1f6dc, 1f6e5], [1f6e9, 1f6e9],
...
PropertyObject * get_EMOJICOMPONENT_PropertyObject() {  return & EMOJICOMPONENT_ns::property_object; }
    namespace EMOJIMODIFIER_ns {
        ...
        const static UnicodeSet::run_t __emojimodifier_set_runs[] = {
        {Empty, 3999}, {Mixed, 1}, {Empty, 30816}};
        const static UnicodeSet::bitquad_t  __emojimodifier_set_quads[] = {
        0xf8000000};
