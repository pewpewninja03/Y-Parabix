...
namespace UCD {
    const static std::vector<std::string> property_enum_name = {
        ...
        "cjkIRG_USource", "cjkIRG_VSource", "cjkRSUnicode", "isc", "JSN",
        "kEH_Cat", "kEH_Desc", "kEH_HG", "kEH_IFAO", "kEH_JSesh", "na",
        "na1", "Name_Alias", "scx", "age", "blk", "sc", "bc", "bpt", "ccc",
        "dt", "ea", "gc", "GCB", "hst", "InCB", "InPC", "InSC", "jg", "jt",
        "lb", "NFC_QC", "NFD_QC", "NFKC_QC", "NFKD_QC", "nt", "SB", "vo",
        "WB", "AHex", "Alpha", "Bidi_C", "Bidi_M", "Cased", "CE", "CI",
        "Comp_Ex", "CWCF", "CWCM", "CWKCF", "CWL", "CWT", "CWU", "Dash",
        "Dep", "DI", "Dia", "EBase", "EComp", "EMod", "Emoji", "EPres",
        "Ext", "ExtPict", "Gr_Base", "Gr_Ext", "Gr_Link", "Hex", "Hyphen",
    ...
    const static std::vector<std::string> property_full_name = {
        ...
        "kIRG_VSource", "kRSUnicode", "ISO_Comment", "Jamo_Short_Name",
        "kEH_Cat", "kEH_Desc", "kEH_HG", "kEH_IFAO", "kEH_JSesh", "Name",
