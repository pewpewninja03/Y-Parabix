...
namespace UCD {
  namespace AGE_ns {
    const unsigned independent_prop_values = 29;
    ...
    [fb3d, fb3d], [fb3f, fb3f], [fb42, fb42], [fb45, fb45], [fe1a, fe1f],
    ...
    [1f252, 1f25f], [1f266, 1f2ff], [1f6d9, 1f6db], [1f6ed, 1f6ef],
    [1f6fd, 1f6ff], [1f7da, 1f7df], [1f7ec, 1f7ef], [1f7f1, 1f7ff],
    [1f80c, 1f80f], [1f848, 1f84f], [1f85a, 1f85f], [1f888, 1f88f],
    [1f8ae, 1f8af], [1f8bc, 1f8bf], [1f8c2, 1f8cf], [1f8d9, 1f8ff],
    [1fa58, 1fa5f], [1fa6e, 1fa6f], [1fa7d, 1fa7f], [1fa8b, 1fa8d],
    [1fac7, 1fac7], [1fac9, 1facc], [1fadd, 1fade], [1faeb, 1faee],
    [1faf9, 1faff], [1fb93, 1fb93], [1fbfb, 1fffd], [2a6e0, 2a6ff],
    [2b81e, 2b81f], [2ceae, 2ceaf], [2ebe1, 2ebef], [2ee5e, 2f7ff],
    [2fa1e, 2fffd], [3134b, 3134f], [3347a, 3fffd], [40000, 4fffd],
    ...
    {Mixed, 1}, {Full, 1}, {Mixed, 3}, {Empty, 21}, {Mixed, 1}, {Empty, 1},
    ...
    {Empty, 4}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Full, 31}, {Mixed, 1},
    {Empty, 1335}, {Full, 1}, {Empty, 136}, {Mixed, 1}, {Empty, 180},
    {Mixed, 1}, {Empty, 233}, {Mixed, 1}, {Empty, 18}, {Mixed, 1},
    {Full, 77}, {Empty, 16}, {Mixed, 1}, {Full, 46}, {Mixed, 1},
    {Empty, 154}, {Mixed, 1}, {Empty, 264}, {Mixed, 1}, {Full, 1627},
    {Mixed, 1}, {Full, 2047}, {Mixed, 1}, {Full, 2047}, {Mixed, 1},
    {Full, 2047}, {Mixed, 1}, {Full, 2047}, {Mixed, 1}, {Full, 2047},
    {Mixed, 1}, {Full, 2047}, {Mixed, 1}, {Full, 2047}, {Mixed, 1},
    {Full, 2047}, {Mixed, 1}, {Full, 2047}, {Mixed, 1}, {Full, 2047},
    {Mixed, 2}, {Empty, 3}, {Full, 4}, {Empty, 7}, {Mixed, 1}, {Full, 2031},
    {Mixed, 1}, {Empty, 4096}};
    ...
    0xfc000000, 0x1f07ff80, 0xa0800000, 0x00000024, 0xfc000000, 0x00080000,
    ...
    0xc0000000, 0x0000fc00, 0x00f00000, 0xf0000000, 0x0000ff00, 0x08007ff0,
    0x00480800, 0xe4040004, 0xfff00000, 0xff800000, 0xffc00000, 0xffffff00,
    0x00000040, 0xf8020000, 0x000002c0, 0x6e400000, 0x00400000, 0x80000000,
    0xffff007f, 0x07c80000, 0x70000000, 0x7c000000, 0xfc000000, 0x0f000000,
    ...
    0xfe00ff03, 0x03ffffff, 0x0000ff00, 0xfc000000, 0x0000ffff, 0xfffffc00,
    ...
    0xfffffc00, 0xffffff00, 0xfc00fffc, 0x00000200, 0x00800000, 0x0000ffc0,
    0x0000e000, 0x00030000, 0xff800100, 0x00000480, 0x4b800000, 0xfc00ff00,
    ...
    0xf8000000, 0x06000000, 0xfff00000, 0x00007800, 0x00007f00, 0xff80ffe0,
    0xffc00000, 0x7fffffff, 0x80000000, 0xfff80000, 0x9010ffff, 0xfffbfff8,
    0xffd8ffff, 0x0000ff0f, 0xf0000000, 0xe000f800, 0x0c00fe00, 0xfffffff0,
    0xe0000000, 0x03f00000, 0xfffe0000, 0xfffe0000, 0x0000c000, 0x0000ff80,
    ...
    0x07fff000, 0xffff0001, 0x80000000, 0xfffff81f, 0x06000080, 0x0000f824,
    0xffffc000, 0xffff7fff, 0xc000e000, 0xffff3c00, 0x0000ffff, 0xffff8000,
    0x7c000000, 0x0000ffff, 0xfc000000, 0x0000ffff, 0x78000000, 0x80000000,
    0x3fc00000, 0x80009080, 0xff800060, 0x3c00f000, 0x0001ffff, 0xffe00000,
    ...
    0xfffcfe00, 0xffffffc0, 0x0e000000, 0xe000e000, 0xfc000000, 0xfffef000,
    0x0000f000, 0xfc00ff00, 0x0000ff00, 0xf000c000, 0xfe00fffc, 0xff000000,
    0xe000c000, 0x00003800, 0x60001e80, 0xfe007800, 0x00080000, 0xf8000000,
    0x3fffffff, 0xc0000000, 0x0000c000, 0x0000fffe, 0xc0000000, 0xc0000000,
    0x3fffffff, 0x0000f800, 0xfc000000, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0xfffffffd, 0xffff0000, 0x3fffffff};
    const static UnicodeSet unassigned_Set{__unassigned_Set_runs, 464, __unassigned_Set_quads, 455};
    ...
    0xe0007f7f};
    const static UnicodeSet v1_1_Set{__v1_1_Set_runs, 111, __v1_1_Set_quads, 151};
    ...
    0xc0000000, 0xc0000000, 0xc0000000, 0xc0000000, 0xc0000000, 0xc0000000};
    const static UnicodeSet v2_0_Set{__v2_0_Set_runs, 43, __v2_0_Set_quads, 24};

    /* Code Point Ranges for V2_1    [20ac, 20ac], [fffc, fffc] */
    const static UnicodeSet::run_t __v2_1_Set_runs[] = {
    {Empty, 261}, {Mixed, 1}, {Empty, 1785}, {Mixed, 1}, {Empty, 32768}};
    const static UnicodeSet::bitquad_t __v2_1_Set_quads[] = {0x00001000, 0x10000000};
    const static UnicodeSet v2_1_Set{__v2_1_Set_runs, 5, __v2_1_Set_quads, 2};
    ...
    const static UnicodeSet v3_0_Set{__v3_0_Set_runs, 97, __v3_0_Set_quads, 78};
    ...
    const static UnicodeSet v3_1_Set{__v3_1_Set_runs, 38, __v3_1_Set_quads, 23};
    ...
    const static UnicodeSet v3_2_Set{__v3_2_Set_runs, 75, __v3_2_Set_quads, 52};
    ...
    const static UnicodeSet v4_0_Set{__v4_0_Set_runs, 97, __v4_0_Set_quads, 59};
    ...
    const static UnicodeSet v4_1_Set{__v4_1_Set_runs, 106, __v4_1_Set_quads, 69};
    ...
    0x00000c00};
    const static UnicodeSet v5_0_Set{__v5_0_Set_runs, 54, __v5_0_Set_quads, 31};
    ...
    const static UnicodeSet v5_1_Set{__v5_1_Set_runs, 112, __v5_1_Set_quads, 74};
    ...
    const static UnicodeSet v5_2_Set{__v5_2_Set_runs, 115, __v5_2_Set_quads, 70};
    ...
    const static UnicodeSet v6_0_Set{__v6_0_Set_runs, 82, __v6_0_Set_quads, 69};
    ...
    const static UnicodeSet v6_1_Set{__v6_1_Set_runs, 67, __v6_1_Set_quads, 46};

    /* Code Point Ranges for V6_2    [20ba, 20ba] */
    const static UnicodeSet::run_t __v6_2_Set_runs[] = {{Empty, 261}, {Mixed, 1}, {Empty, 34554}};
    const static UnicodeSet::bitquad_t __v6_2_Set_quads[] = {0x04000000};
    const static UnicodeSet v6_2_Set{__v6_2_Set_runs, 3, __v6_2_Set_quads, 1};

    /* Code Point Ranges for V6_3    [061c, 061c], [2066, 2069] */
    const static UnicodeSet::run_t __v6_3_Set_runs[] = {
    {Empty, 48}, {Mixed, 1}, {Empty, 210}, {Mixed, 1}, {Empty, 34556}};
    const static UnicodeSet::bitquad_t __v6_3_Set_quads[] = {0x10000000, 0x000003c0};
    const static UnicodeSet v6_3_Set{__v6_3_Set_runs, 5, __v6_3_Set_quads, 2};
    ...
    const static UnicodeSet v7_0_Set{__v7_0_Set_runs, 158, __v7_0_Set_quads, 110};
    ...
    const static UnicodeSet v8_0_Set{__v8_0_Set_runs, 90, __v8_0_Set_quads, 48};
    ...
    const static UnicodeSet v9_0_Set{__v9_0_Set_runs, 57, __v9_0_Set_quads, 42};
    ...
    const static UnicodeSet v10_0_Set{__v10_0_Set_runs, 56, __v10_0_Set_quads, 38};
    ...
    const static UnicodeSet v11_0_Set{__v11_0_Set_runs, 83, __v11_0_Set_quads, 52};
    ...
    const static UnicodeSet v12_0_Set{__v12_0_Set_runs, 63, __v12_0_Set_quads, 44};

    /* Code Point Ranges for V12_1    [32ff, 32ff] */
    const static UnicodeSet::run_t __v12_1_Set_runs[] = {{Empty, 407}, {Mixed, 1}, {Empty, 34408}};
    const static UnicodeSet::bitquad_t __v12_1_Set_quads[] = {0x80000000};
    const static UnicodeSet v12_1_Set{__v12_1_Set_runs, 3, __v12_1_Set_quads, 1};
    ...
    const static UnicodeSet v13_0_Set{__v13_0_Set_runs, 80, __v13_0_Set_quads, 51};

    /* Code Point Ranges for V14_0
    [061d, 061d], [0870, 088e], [0890, 0891], [0898, 089f], [08b5, 08b5],
    [08c8, 08d2], [0c3c, 0c3c], [0c5d, 0c5d], [0cdd, 0cdd], [170d, 170d],
    [1715, 1715], [171f, 171f], [180f, 180f], [1ac1, 1ace], [1b4c, 1b4c],
    [1b7d, 1b7e], [1dfa, 1dfa], [20c0, 20c0], [2c2f, 2c2f], [2c5f, 2c5f],
    [2e53, 2e5d], [9ffd, 9fff], [a7c0, a7c1], [a7d0, a7d1], [a7d3, a7d3],
    [a7d5, a7d9], [a7f2, a7f4], [fbc2, fbc2], [fd40, fd4f], [fdcf, fdcf],
    [fdfe, fdff], [10570, 1057a], [1057c, 1058a], [1058c, 10592],
    [10594, 10595], [10597, 105a1], [105a3, 105b1], [105b3, 105b9],
    [105bb, 105bc], [10780, 10785], [10787, 107b0], [107b2, 107ba],
    [10f70, 10f89], [11070, 11075], [110c2, 110c2], [116b9, 116b9],
    [11740, 11746], [11ab0, 11abf], [12f90, 12ff2], [16a70, 16abe],
    [16ac0, 16ac9], [1aff0, 1aff3], [1aff5, 1affb], [1affd, 1affe],
    [1b11f, 1b122], [1cf00, 1cf2d], [1cf30, 1cf46], [1cf50, 1cfc3],
    [1d1e9, 1d1ea], [1df00, 1df1e], [1e290, 1e2ae], [1e7e0, 1e7e6],
    [1e7e8, 1e7eb], [1e7ed, 1e7ee], [1e7f0, 1e7fe], [1f6dd, 1f6df],
    [1f7f0, 1f7f0], [1f979, 1f979], [1f9cc, 1f9cc], [1fa7b, 1fa7c],
    [1faa9, 1faac], [1fab7, 1faba], [1fac3, 1fac5], [1fad7, 1fad9],
    [1fae0, 1fae7], [1faf0, 1faf6], [2a6de, 2a6df], [2b735, 2b738] */
    const static UnicodeSet::run_t __v14_0_Set_runs[] = {
    {Empty, 48}, {Mixed, 1}, {Empty, 18}, {Mixed, 4}, {Empty, 26},
    {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Empty, 81}, {Mixed, 1}, {Empty, 7},
    {Mixed, 1}, {Empty, 21}, {Mixed, 1}, {Empty, 3}, {Mixed, 2},
    {Empty, 19}, {Mixed, 1}, {Empty, 22}, {Mixed, 1}, {Empty, 90},
    {Mixed, 2}, {Empty, 15}, {Mixed, 1}, {Empty, 908}, {Mixed, 1},
    {Empty, 62}, {Mixed, 2}, {Empty, 670}, {Mixed, 1}, {Empty, 11},
    {Mixed, 1}, {Empty, 3}, {Mixed, 2}, {Empty, 59}, {Mixed, 3},
    {Empty, 14}, {Mixed, 2}, {Empty, 61}, {Mixed, 2}, {Empty, 6},
    {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 46}, {Mixed, 1}, {Empty, 4},
    {Mixed, 1}, {Empty, 26}, {Mixed, 1}, {Empty, 166}, {Mixed, 1},
    {Full, 2}, {Mixed, 1}, {Empty, 467}, {Mixed, 1}, {Full, 1}, {Mixed, 2},
    {Empty, 552}, {Mixed, 1}, {Empty, 8}, {Mixed, 2}, {Empty, 238},
    {Full, 1}, {Mixed, 2}, {Full, 3}, {Mixed, 1}, {Empty, 16}, {Mixed, 1},
    {Empty, 104}, {Mixed, 1}, {Empty, 27}, {Mixed, 2}, {Empty, 41},
    {Mixed, 1}, {Empty, 118}, {Mixed, 1}, {Empty, 8}, {Mixed, 1},
    {Empty, 11}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 4}, {Mixed, 1},
    {Empty, 1}, {Mixed, 3}, {Empty, 1374}, {Mixed, 1}, {Empty, 130},
    {Mixed, 1}, {Empty, 29254}};
    const static UnicodeSet::bitquad_t __v14_0_Set_quads[] = {
    0x20000000, 0xffff0000, 0xff037fff, 0x00200000, 0x0007ff00, 0x10000000,
    0x20000000, 0x20000000, 0x80202000, 0x00008000, 0x00007ffe, 0x00001000,
    0x60000000, 0x04000000, 0x00000001, 0x00008000, 0x80000000, 0x3ff80000,
    0xe0000000, 0x03eb0003, 0x001c0000, 0x00000004, 0x0000ffff, 0x00008000,
    0xc0000000, 0xf7ff0000, 0xffb7f7ff, 0x1bfbfffb, 0xffffffbf, 0x07fdffff,
    0xffff0000, 0x000003ff, 0x003f0000, 0x00000004, 0x02000000, 0x0000007f,
    0xffff0000, 0xffff0000, 0x0007ffff, 0xffff0000, 0x7fffffff, 0x000003ff,
    0x6fef0000, 0x80000000, 0x00000007, 0xffff3fff, 0xffff007f, 0x0000000f,
    0x00000600, 0x7fffffff, 0xffff0000, 0x00007fff, 0x7fff6f7f, 0xe0000000,
    0x00010000, 0x02000000, 0x00001000, 0x18000000, 0x07801e00, 0x03800038,
    0x007f00ff, 0xc0000000, 0x01e00000};
    const static UnicodeSet v14_0_Set{__v14_0_Set_runs, 92, __v14_0_Set_quads, 63};

    /* Code Point Ranges for V15_0
    [0cf3, 0cf3], [0ece, 0ece], [10efd, 10eff], [1123f, 11241],
    [11b00, 11b09], [11f00, 11f10], [11f12, 11f3a], [11f3e, 11f59],
    [1342f, 1342f], [13439, 13455], [1b132, 1b132], [1b155, 1b155],
    [1d2c0, 1d2d3], [1df25, 1df2a], [1e030, 1e06d], [1e08f, 1e08f],
    [1e4d0, 1e4f9], [1f6dc, 1f6dc], [1f774, 1f776], [1f77b, 1f77f],
    [1f7d9, 1f7d9], [1fa75, 1fa77], [1fa87, 1fa88], [1faad, 1faaf],
    [1fabb, 1fabd], [1fabf, 1fabf], [1face, 1facf], [1fada, 1fadb],
    [1fae8, 1fae8], [1faf7, 1faf8], [2b739, 2b739], [31350, 323af] */
    const static UnicodeSet::run_t __v15_0_Set_runs[] = {
    {Empty, 103}, {Mixed, 1}, {Empty, 14}, {Mixed, 1}, {Empty, 2048},
    {Mixed, 1}, {Empty, 25}, {Mixed, 2}, {Empty, 69}, {Mixed, 1},
    {Empty, 31}, {Mixed, 3}, {Empty, 166}, {Mixed, 2}, {Empty, 998},
    {Mixed, 2}, {Empty, 267}, {Mixed, 1}, {Empty, 98}, {Mixed, 1},
    {Empty, 7}, {Mixed, 1}, {Full, 1}, {Mixed, 2}, {Empty, 33}, {Mixed, 2},
    {Empty, 142}, {Mixed, 1}, {Empty, 4}, {Mixed, 1}, {Empty, 2},
    {Mixed, 1}, {Empty, 20}, {Mixed, 5}, {Empty, 1505}, {Mixed, 1},
    {Empty, 736}, {Mixed, 1}, {Full, 130}, {Mixed, 1}, {Empty, 28386}};
    const static UnicodeSet::bitquad_t __v15_0_Set_quads[] = {
    0x00080000, 0x00004000, 0xe0000000, 0x80000000, 0x00000003, 0x000003ff,
    0xfffdffff, 0xc7ffffff, 0x03ffffff, 0xfe008000, 0x003fffff, 0x00040000,
    0x00200000, 0x000fffff, 0x000007e0, 0xffff0000, 0x00003fff, 0x00008000,
    0xffff0000, 0x03ffffff, 0x10000000, 0xf8700000, 0x02000000, 0x00e00000,
    0x00000180, 0xb800e000, 0x0c00c000, 0x01800100, 0x02000000, 0xffff0000,
    0x0000ffff};
    const static UnicodeSet v15_0_Set{__v15_0_Set_runs, 41, __v15_0_Set_quads, 31};

    /* Code Point Ranges for V15_1    [2ffc, 2fff], [31ef, 31ef], [2ebf0, 2ee5d] */
    const static UnicodeSet::run_t __v15_1_Set_runs[] = {
    {Empty, 383}, {Mixed, 1}, {Empty, 15}, {Mixed, 1}, {Empty, 5583},
    {Mixed, 1}, {Full, 18}, {Mixed, 1}, {Empty, 28813}};
    const static UnicodeSet::bitquad_t __v15_1_Set_quads[] = {
    0xf0000000, 0x00008000, 0xffff0000, 0x3fffffff};
    const static UnicodeSet v15_1_Set{__v15_1_Set_runs, 9, __v15_1_Set_quads, 4};

    /* Code Point Ranges for V16_0
    [0897, 0897], [1b4e, 1b4f], [1b7f, 1b7f], [1c89, 1c8a], [2427, 2429],
    [31e4, 31e5], [a7cb, a7cd], [a7da, a7dc], [105c0, 105f3],
    [10d40, 10d65], [10d69, 10d85], [10d8e, 10d8f], [10ec2, 10ec4],
    [10efc, 10efc], [11380, 11389], [1138b, 1138b], [1138e, 1138e],
    [11390, 113b5], [113b7, 113c0], [113c2, 113c2], [113c5, 113c5],
    [113c7, 113ca], [113cc, 113d5], [113d7, 113d8], [113e1, 113e2],
    [116d0, 116e3], [11bc0, 11be1], [11bf0, 11bf9], [11f5a, 11f5a],
    [13460, 143fa], [16100, 16139], [16d40, 16d79], [18cff, 18cff],
    [1cc00, 1ccf9], [1cd00, 1ceb3], [1e5d0, 1e5fa], [1e5ff, 1e5ff],
    [1f8b2, 1f8bb], [1f8c0, 1f8c1], [1fa89, 1fa89], [1fa8f, 1fa8f],
    [1fabe, 1fabe], [1fac6, 1fac6], [1fadc, 1fadc], [1fadf, 1fadf],
    [1fae9, 1fae9], [1fbcb, 1fbef] */
    const static UnicodeSet::run_t __v16_0_Set_runs[] = {
    {Empty, 68}, {Mixed, 1}, {Empty, 149}, {Mixed, 2}, {Empty, 8},
    {Mixed, 1}, {Empty, 60}, {Mixed, 1}, {Empty, 109}, {Mixed, 1},
    {Empty, 942}, {Mixed, 1}, {Empty, 751}, {Full, 1}, {Mixed, 1},
    {Empty, 58}, {Full, 1}, {Mixed, 2}, {Empty, 9}, {Mixed, 2}, {Empty, 36},
    {Mixed, 4}, {Empty, 22}, {Mixed, 2}, {Empty, 38}, {Full, 1}, {Mixed, 1},
    {Empty, 26}, {Mixed, 1}, {Empty, 168}, {Full, 124}, {Mixed, 1},
    {Empty, 232}, {Full, 1}, {Mixed, 1}, {Empty, 96}, {Full, 1}, {Mixed, 1},
    {Empty, 251}, {Mixed, 1}, {Empty, 504}, {Full, 7}, {Mixed, 1},
    {Full, 13}, {Mixed, 1}, {Empty, 184}, {Mixed, 2}, {Empty, 149},
    {Mixed, 2}, {Empty, 13}, {Mixed, 4}, {Empty, 6}, {Mixed, 2},
    {Empty, 30752}};
    const static UnicodeSet::bitquad_t __v16_0_Set_quads[] = {
    0x00800000, 0x0000c000, 0x80000000, 0x00000600, 0x00000380, 0x00000030,
    0x1c003800, 0x000fffff, 0xfffffe3f, 0x0000c03f, 0x0000001c, 0x10000000,
    0xffff4bff, 0xffbfffff, 0x01bff7a5, 0x00000006, 0xffff0000, 0x0000000f,
    0x03ff0003, 0x04000000, 0x07ffffff, 0x03ffffff, 0x03ffffff, 0x80000000,
    0x03ffffff, 0x000fffff, 0xffff0000, 0x87ffffff, 0x0ffc0000, 0x00000003,
    0x00008200, 0x40000000, 0x90000040, 0x00000200, 0xfffff800, 0x0000ffff};
    const static UnicodeSet v16_0_Set{__v16_0_Set_runs, 54, __v16_0_Set_quads, 36};

    /* Code Point Ranges for V17_0
    [088f, 088f], [0c5c, 0c5c], [0cdc, 0cdc], [1acf, 1add], [1ae0, 1aeb],
    [20c1, 20c1], [2b96, 2b96], [a7ce, a7cf], [a7d2, a7d2], [a7d4, a7d4],
    [a7f1, a7f1], [fbc3, fbd2], [fd90, fd91], [fdc8, fdce], [10940, 10959],
    [10ec5, 10ec7], [10ed0, 10ed8], [10efa, 10efb], [11b60, 11b67],
    [11db0, 11ddb], [11de0, 11de9], [16ea0, 16eb8], [16ebb, 16ed3],
    [16ff2, 16ff6], [187f8, 187ff], [18d09, 18d1e], [18d80, 18df2],
    [1ccfa, 1ccfc], [1ceba, 1ced0], [1cee0, 1cef0], [1e6c0, 1e6de],
    [1e6e0, 1e6f5], [1e6fe, 1e6ff], [1f6d8, 1f6d8], [1f777, 1f77a],
    [1f8d0, 1f8d8], [1fa54, 1fa57], [1fa8a, 1fa8a], [1fa8e, 1fa8e],
    [1fac8, 1fac8], [1facd, 1facd], [1faea, 1faea], [1faef, 1faef],
    [1fbfa, 1fbfa], [2b73a, 2b73f], [2cea2, 2cead], [323b0, 33479] */
    const static UnicodeSet::run_t __v17_0_Set_runs[] = {
    {Empty, 68}, {Mixed, 1}, {Empty, 29}, {Mixed, 1}, {Empty, 3},
    {Mixed, 1}, {Empty, 111}, {Mixed, 2}, {Empty, 46}, {Mixed, 1},
    {Empty, 85}, {Mixed, 1}, {Empty, 993}, {Mixed, 2}, {Empty, 670},
    {Mixed, 1}, {Empty, 13}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
    {Empty, 91}, {Mixed, 1}, {Empty, 43}, {Mixed, 2}, {Empty, 99},
    {Mixed, 1}, {Empty, 17}, {Mixed, 3}, {Empty, 645}, {Mixed, 2},
    {Empty, 8}, {Mixed, 1}, {Empty, 191}, {Mixed, 1}, {Empty, 40},
    {Mixed, 1}, {Empty, 3}, {Full, 3}, {Mixed, 1}, {Empty, 503}, {Mixed, 1},
    {Empty, 13}, {Mixed, 3}, {Empty, 190}, {Mixed, 2}, {Empty, 126},
    {Mixed, 1}, {Empty, 4}, {Mixed, 1}, {Empty, 10}, {Mixed, 1},
    {Empty, 11}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
    {Empty, 7}, {Mixed, 1}, {Empty, 1497}, {Mixed, 1}, {Empty, 187},
    {Mixed, 1}, {Empty, 679}, {Mixed, 1}, {Full, 133}, {Mixed, 1},
    {Empty, 28252}};
    const static UnicodeSet::bitquad_t __v17_0_Set_quads[] = {
    0x00008000, 0x10000000, 0x10000000, 0x3fff8000, 0x00000fff, 0x00000002,
    0x00400000, 0x0014c000, 0x00020000, 0x0007fff8, 0x00030000, 0x00007f00,
    0x03ffffff, 0x01ff00e0, 0x0c000000, 0x000000ff, 0xffff0000, 0x0fffffff,
    0x000003ff, 0xf9ffffff, 0x000fffff, 0x007c0000, 0xff000000, 0x7ffffe00,
    0x0007ffff, 0x1c000000, 0xfc000000, 0x0001ffff, 0x0001ffff, 0x7fffffff,
    0xc03fffff, 0x01000000, 0x07800000, 0x01ff0000, 0x00f00000, 0x00004400,
    0x00002100, 0x00008400, 0x04000000, 0xfc000000, 0x00003ffc, 0xffff0000,
    0x03ffffff};
    const static UnicodeSet v17_0_Set{__v17_0_Set_runs, 68, __v17_0_Set_quads, 43};
    static EnumeratedPropertyObject property_object
        ...
        &v12_1_Set, &v13_0_Set, &v14_0_Set, &v15_0_Set, &v15_1_Set,
        &v16_0_Set, &v17_0_Set
        }};
    }
