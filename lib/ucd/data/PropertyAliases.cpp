...
namespace UCD {
    const static std::vector<std::string> property_enum_name = {
        "identity", "cjkAccountingNumeric", "cjkOtherNumeric",
        "cjkPrimaryNumeric", "nv", "bmg", "bpb", "cf",
        "cjkCompatibilityVariant", "dm", "EqUIdeo", "FC_NFKC", "lc",
        "NFKC_CF", "NFKC_SCF", "scf", "slc", "stc", "suc", "tc", "uc",
        ...
        "cjkIRG_USource", "cjkIRG_VSource", "cjkMandarin", "cjkRSUnicode",
        "cjkTotalStrokes", "cjkUnihanCore2020", "isc", "JSN", "kEH_Cat",
        "kEH_Desc", "kEH_HG", "kEH_IFAO", "kEH_JSesh", "na", "na1",
        "Name_Alias", "scx", "age", "blk", "sc", "bc", "bpt", "ccc", "dt",
        "ea", "gc", "GCB", "hst", "InCB", "InPC", "InSC", "jg", "jt", "lb",
        "NFC_QC", "NFD_QC", "NFKC_QC", "NFKD_QC", "nt", "SB", "vo", "WB",
        "AHex", "Alpha", "Bidi_C", "Bidi_M", "Cased", "CE", "CI", "Comp_Ex",
        "CWCF", "CWCM", "CWKCF", "CWL", "CWT", "CWU", "Dash", "Dep", "DI",
        "Dia", "EBase", "EComp", "EMod", "Emoji", "EPres", "Ext", "ExtPict",
        "Gr_Base", "Gr_Ext", "Gr_Link", "Hex", "Hyphen",
        "ID_Compat_Math_Continue", "ID_Compat_Math_Start", "IDC", "Ideo",
        "IDS", "IDSB", "IDST", "IDSU", "Join_C", "kEH_NoMirror",
        "kEH_NoRotate", "LOE", "Lower", "Math", "MCM", "NChar", "OAlpha",
        "ODI", "OGr_Ext", "OIDC", "OIDS", "OLower", "OMath", "OUpper",
        "Pat_Syn", "Pat_WS", "PCM", "QMark", "Radical", "RI", "SD", "STerm",
        "Term", "UIdeo", "Upper", "VS", "WSpace", "XIDC", "XIDS", "XO_NFC",
        "XO_NFD", "XO_NFKC", "XO_NFKD", "emoji", "emojipresentation",
        "emojimodifier", "emojimodifierbase", "emojicomponent",
        "extendedpictographic", "alnum", "xdigit", "blank", "print", "word",
        "graph", "g", "w"};
    const static std::vector<std::string> property_full_name = {
        "Identity", "kAccountingNumeric", "kOtherNumeric",
        "kPrimaryNumeric", "Numeric_Value", "Bidi_Mirroring_Glyph",
        "Bidi_Paired_Bracket", "Case_Folding", "kCompatibilityVariant",
        "Decomposition_Mapping", "Equivalent_Unified_Ideograph",
        "FC_NFKC_Closure", "Lowercase_Mapping", "NFKC_Casefold",
        "NFKC_Simple_Casefold", "Simple_Case_Folding",
        "Simple_Lowercase_Mapping", "Simple_Titlecase_Mapping",
        "Simple_Uppercase_Mapping", "Titlecase_Mapping",
        "Uppercase_Mapping", "kIICore", "kIRG_GSource", "kIRG_HSource",
        "kIRG_JSource", "kIRG_KPSource", "kIRG_KSource", "kIRG_MSource",
        "kIRG_SSource", "kIRG_TSource", "kIRG_UKSource", "kIRG_USource",
        "kIRG_VSource", "kMandarin", "kRSUnicode", "kTotalStrokes",
        "kUnihanCore2020", "ISO_Comment", "Jamo_Short_Name", "kEH_Cat",
        "kEH_Desc", "kEH_HG", "kEH_IFAO", "kEH_JSesh", "Name",
        "Unicode_1_Name", "Name_Alias", "Script_Extensions", "Age", "Block",
        "Script", "Bidi_Class", "Bidi_Paired_Bracket_Type",
        "Canonical_Combining_Class", "Decomposition_Type",
        "East_Asian_Width", "General_Category", "Grapheme_Cluster_Break",
        "Hangul_Syllable_Type", "Indic_Conjunct_Break",
        "Indic_Positional_Category", "Indic_Syllabic_Category",
        "Joining_Group", "Joining_Type", "Line_Break", "NFC_Quick_Check",
        "NFD_Quick_Check", "NFKC_Quick_Check", "NFKD_Quick_Check",
        "Numeric_Type", "Sentence_Break", "Vertical_Orientation",
        "Word_Break", "ASCII_Hex_Digit", "Alphabetic", "Bidi_Control",
        "Bidi_Mirrored", "Cased", "Composition_Exclusion", "Case_Ignorable",
        ...
        "ID_Compat_Math_Continue", "ID_Compat_Math_Start", "ID_Continue",
        "Ideographic", "ID_Start", "IDS_Binary_Operator",
        "IDS_Trinary_Operator", "IDS_Unary_Operator", "Join_Control",
        "kEH_NoMirror", "kEH_NoRotate", "Logical_Order_Exception",
        "Lowercase", "Math", "Modifier_Combining_Mark",
    ...
    static std::unordered_map<std::string, int> alias_map {{
        ...
        {"cjkirgvsource", cjkIRG_VSource}, {"cjkmandarin", cjkMandarin},
        ...
        {"cjkunihancore2020", cjkUnihanCore2020}, {"compex", Comp_Ex},
        ...
        {"idcompatmathstart", ID_Compat_Math_Start}, {"idcontinue", IDC},
        {"identity", identity}, {"ideo", Ideo}, {"ideographic", Ideo},
        {"ids", IDS}, {"idsb", IDSB}, {"idsbinaryoperator", IDSB},
        {"idst", IDST}, {"idstart", IDS}, {"idstrinaryoperator", IDST},
        {"idsu", IDSU}, {"idsunaryoperator", IDSU}, {"incb", InCB},
        {"indicconjunctbreak", InCB}, {"indicpositionalcategory", InPC},
        ...
        {"kehcat", kEH_Cat}, {"kehdesc", kEH_Desc}, {"kehhg", kEH_HG},
        {"kehifao", kEH_IFAO}, {"kehjsesh", kEH_JSesh},
        {"kehnomirror", kEH_NoMirror}, {"kehnorotate", kEH_NoRotate},
        ...
        {"kmandarin", cjkMandarin}, {"kothernumeric", cjkOtherNumeric},
        {"kprimarynumeric", cjkPrimaryNumeric},
        {"krsunicode", cjkRSUnicode}, {"ktotalstrokes", cjkTotalStrokes},
        {"kunihancore2020", cjkUnihanCore2020}, {"lb", lb}, {"lc", lc},
        {"linebreak", lb}, {"loe", LOE}, {"logicalorderexception", LOE},
        {"lower", Lower}, {"lowercase", Lower}, {"lowercasemapping", lc},
        {"math", Math}, {"mcm", MCM}, {"modifiercombiningmark", MCM},
        {"na", na}, {"na1", na1}, {"name", na}, {"namealias", Name_Alias},
        {"nchar", NChar}, {"nfcqc", NFC_QC}, {"nfcquickcheck", NFC_QC},
        {"nfdqc", NFD_QC}, {"nfdquickcheck", NFD_QC},
        {"nfkccasefold", NFKC_CF}, {"nfkccf", NFKC_CF}, {"nfkcqc", NFKC_QC},
        {"nfkcquickcheck", NFKC_QC}, {"nfkcscf", NFKC_SCF},
        {"nfkcsimplecasefold", NFKC_SCF}, {"nfkdqc", NFKD_QC},
