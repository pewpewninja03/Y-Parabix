...
namespace UCD {
  namespace VO_ns {
    ...
    [1680, 18af], [1900, 2015], [2017, 2017], [201a, 201b], [201e, 201f],
    [2022, 202f], [2032, 203a], [203d, 2041], [2043, 2046], [204a, 2050],
    [2052, 2064], [2066, 20dc], [20e1, 20e1], [20e5, 20ff], [2102, 2102],
    [210a, 210e], [2110, 2112], [2115, 2115], [2118, 211d], [2124, 2124],
    [2126, 2126], [2128, 2128], [212a, 212d], [212f, 2134], [2140, 2144],
    [214b, 214b], [214e, 214e], [218a, 218b], [2190, 221d], [221f, 2233],
    [2236, 22ff], [2308, 230b], [2320, 2323], [232c, 237c], [239b, 23bd],
    [23ce, 23ce], [23d0, 23d0], [23dc, 23e1], [2423, 2423], [2500, 259f],
    [261a, 261f], [2768, 2775], [2794, 2b11], [2b30, 2b4f], [2b5a, 2b96],
    [2b98, 2bb7], [2bd2, 2bd2], [2bec, 2bef], [2c00, 2e4f], [2e52, 2e7f],
    [a4d0, a95f], [a980, abff], [d800, dfff], [fb00, fe0f], [fe20, fe2f],
    ...
    [30f7, 30fb], [30fd, 3126], [3128, 31b3], [31b8, 31ba], [31bc, 31ef],
    [3200, 32fe], [3358, 337a], [3380, a4cf], [a960, a97f], [ac00, d7ff],
    [e000, faff], [fe10, fe1f], [fe30, fe48], [fe53, fe57], [fe5f, fe62],
    ...
    {Full, 1}, {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 1}, {Mixed, 1},
    {Full, 7}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Full, 906}, {Mixed, 1},
    {Empty, 36}, {Full, 1}, {Empty, 20}, {Full, 352}, {Empty, 64},
    ...
    [3030, 3030], [30a0, 30a0], [30fc, 30fc], [fe59, fe5e], [ff08, ff09],
    [ff1a, ff1b], [ff3b, ff3b], [ff3d, ff3d], [ff3f, ff3f], [ff5b, ff60],
    [ffe3, ffe3] */
    const static UnicodeSet::run_t __tr_Set_runs[] = {
    {Empty, 256}, {Mixed, 1}, {Empty, 24}, {Mixed, 1}, {Empty, 102},
    {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
    {Empty, 1642}, {Mixed, 1}, {Empty, 5}, {Mixed, 4}, {Empty, 3},
    {Mixed, 1}, {Empty, 32768}};
    const static UnicodeSet::bitquad_t __tr_Set_quads[] = {
    0x33000000, 0x00000600, 0xfff3ff00, 0x00010000, 0x00000001, 0x10000000,
    0x7e000000, 0x0c000300, 0xa8000000, 0xf8000000, 0x00000001, 0x00000008};
    const static UnicodeSet tr_Set{__tr_Set_runs, 17, __tr_Set_quads, 12};
    ...
    {Mixed, 1}, {Full, 2}, {Mixed, 2}, {Empty, 1622}, {Mixed, 1},
    {Empty, 5}, {Mixed, 1}, {Empty, 1424}, {Mixed, 3}, {Empty, 516},
    {Mixed, 1}, {Empty, 30831}};
    ...
    static EnumeratedPropertyObject property_object
        ...
        std::move(VO_ns::aliases),{
        &r_Set, &u_Set, &tr_Set, &tu_Set
        }};
    }
PropertyObject * get_VO_PropertyObject() {  return & VO_ns::property_object; }
}
